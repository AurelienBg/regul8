...
export const REGULATIONS: RegData = {
  ...
  exchange: {
    eu: {
      regime: "MiCA — Title V (CASP, Art. 59+) — pan-EU exchange framework",
      risk: "high",
      licenses: ["CASP authorisation under MiCA", "Passport across all EU-27 Member States once granted (Art. 65)"],
      obligations: ["KYC/KYB per AMLD6 + EU AML Package 2024", "AML/CFT program", "MiCA whitepaper for non-listed tokens (already-traded exemption Art. 4(2) for XRP/BTC/ETH)", "Capital min. €125K (CASP exchange tier — Art. 67)", "FATF Travel Rule >€1K (TFR Reg. 2023/1113)", "Market abuse rules (MiCA Art. 80+)", "Governance & fit-and-proper (Art. 68)", "Environmental impact disclosure (Art. 66)"],
      time: "6–18 months (depends on chosen NCA — LT fastest, IE/LU/MT slower)",
      cost: "€50K–€500K (varies by hub: LT cheapest, IE/LU more expensive)",
      alts: ["Pick a Member-State juri (FR / IE / LU / LT / MT) for actual licensing — passporting via the cheapest hub (typically Lithuania) is standard", "Outside EU: UK FCA, Switzerland FINMA, Liechtenstein TVTG (with EEA passport)"],
      authority: "ESMA (level-2 standards) + national competent authorities (NCAs) per Member State — actual licensing happens at NCA level",
      xrplNote: "XRPL has a native DEX (order book built into the protocol). A front-end DApp accessing it for EU users still needs CASP if it routes orders or controls funds — independent of which NCA issues the licence.",
      reportingFrequency: "Quarterly prudential + transaction reports to home-state NCA · Annual audited accounts · Monthly AML filings · Immediate incident reports · MiCA Art. 80 conflicts-of-interest report annually.",
      ...
      clientEligibility: "Single passported CASP serves all EU-27 residents. Enhanced due diligence for PEPs and FATF grey/black-list countries. No retail restriction but suitability test required for complex products. Must geo-block non-EU jurisdictions without reverse-solicitation chain."
    },
    fr: {
    ...
    il: {
      regime: "Financial Services Regulation Law 2016 (CMISA) + AML Order 2018 (IMPA) — crypto exchanges supervised as non-bank financial services providers.",
      risk: "med",
      licenses: ["CMISA Regulated Financial Services Provider (RFSP) licence", "IMPA registration (financial-services AML)", "ISA approval if any listed token is a security under Securities Law 1968"],
      obligations: ["Full KYC/CDD per AML Order 2018", "Suspicious Transaction Reports to IMPA", "ILS-denominated capital + insurance per CMISA tier", "Source-of-funds checks", "Sanctions screening (Israeli + UN + OFAC)"],
      time: "9–15 months",
      cost: "$150K–$500K (capital + setup)",
      alts: ["Dubai VARA", "EU MiCA via Lithuania or Cyprus", "Singapore MAS"],
      authority: "CMISA + IMPA + ISA (for security tokens)"
    },
    id: {
      regime: "Bappebti — Physical Crypto Asset Trading regime (Reg. 8/2021). Transition to OJK in 2025 under Law 4/2023 (UU P2SK) reframes crypto as a financial instrument.",
      risk: "med",
      licenses: ["Bappebti PFAK licence (Pedagang Fisik Aset Kripto)", "CFX (Indonesia Crypto-Asset Futures Exchange) membership mandatory", "OJK supervision from 2025"],
      obligations: ["IDR 100B paid-up capital (~$6M)", "Local Indonesian incorporation + local director", "Mandatory CFX clearing", "Bappebti-approved coin list only (~229 tokens)", "0.1% transaction tax (income + VAT)", "KYC + AML per Bappebti rules"],
      time: "9–15 months",
      cost: "$6M paid-up + $200K–$500K legal",
      alts: ["Singapore MAS", "Dubai VARA", "Australia AUSTRAC"],
      authority: "Bappebti (transitioning to OJK in 2025)"
    },
    gh: {
      regime: "No comprehensive crypto law yet — Bank of Ghana / SEC Ghana sandbox programme + draft Virtual Asset Providers Act (VAPA, 2024 expected). Crypto exchanges currently operate in a regulatory grey zone, with banking-sector exposure restricted.",
      risk: "high",
      licenses: ["BoG/SEC sandbox admission (case-by-case)", "Future VAPA licence once enacted", "FIC Ghana AML registration"],
      obligations: ["AML per Act 1044 (Anti-Money Laundering Act 2020)", "STR/SAR filings to FIC Ghana", "Sandbox-specific reporting to BoG", "No bank-rail for crypto on/off-ramps until VAPA passes"],
      time: "6–12 months (sandbox) · 12–24+ months (VAPA, pending)",
      cost: "$50K–$200K (sandbox + legal)",
      alts: ["South Africa FSCA", "Mauritius VASP", "Dubai VARA"],
      authority: "Bank of Ghana + SEC Ghana + FIC Ghana"
    },
    cm: {
      regime: "BEAC May-2022 directive prohibits the use of crypto as a means of payment across the CEMAC zone. No domestic exchange licence available; Cameroonian banks cannot service crypto businesses.",
      risk: "high",
      licenses: ["No exchange licence available", "Operating from Cameroon effectively blocked"],
      obligations: ["BEAC ban compliance — no crypto/fiat banking rail", "ANTIC warning notices on crypto-related fraud", "Operate from outside CEMAC if targeting other markets"],
      time: "n/a (no licensing path)",
      cost: "Legal review + offshore restructuring $50K–$200K",
      alts: ["Nigeria SEC + CBN (post-2023 reopening)", "Ghana BoG sandbox", "Senegal/Côte d'Ivoire — UEMOA zone"],
      authority: "BEAC + COBAC (banking ban) + ANTIC (ICT)"
    },
    ar: {
      regime: "Law 27.739 (March 2024) created the PSAV (Proveedor de Servicios de Activos Virtuales) registry under CNV — mandatory for any crypto exchange offering services to Argentine residents. Aligns with FATF Recommendation 15.",
      risk: "med",
      licenses: ["CNV PSAV registration", "UIF AML registration (Resolution 49/2024)", "AFIP tax registration"],
      obligations: ["Local incorporation OR foreign-entity registration", "KYC/AML per UIF Res. 49/2024", "Asset segregation", "AFIP transaction reporting (BCRA forex controls)", "Quarterly CNV reporting"],
      time: "6–12 months",
      cost: "$50K–$200K (legal + compliance setup)",
      alts: ["Brazil BCB VASP", "Uruguay (lighter regime)", "EU MiCA via Spain (Spanish-speaking onboarding)"],
      authority: "CNV + UIF + BCRA"
    },
    sv: {
      regime: "Digital Assets Issuance Law (LEAD, Jan 2023) — CNAD-supervised PSAD framework for non-Bitcoin exchanges. Bitcoin-only exchanges fall under the 2021 Bitcoin Law (BSP licence). Pro-crypto stance.",
      risk: "med",
      licenses: ["CNAD PSAD licence (non-Bitcoin assets)", "BSP licence (Bitcoin-only services)", "Local incorporation"],
      obligations: ["KYC/AML per CNAD rules", "Local director + minimum staffing", "Annual financial statements", "USD-denominated capital (no SVC)"],
      time: "6–12 months",
      cost: "$200K–$700K (capital + legal + setup)",
      alts: ["Panama (no specific crypto licence)", "Bahamas DARE Act", "EU MiCA via Spain"],
      authority: "CNAD + BCR"
    }
  },
  ...
  stablecoin: {
    eu: {
      regime: "MiCA — Title III (EMT, Art. 48+) or Title IV (ART, Art. 16+) — pan-EU stablecoin framework",
      risk: "high",
      licenses: ["EMI or credit institution licence (EMT) — supervised by EBA + home NCA", "ART authorisation by home NCA (significant ART → direct ECB/EBA supervision)", "CASP licence required if distributing third-party stablecoins"],
      obligations: ["1:1 reserve requirement for EMT (cash + HQLA only)", "Whitepaper filed with home NCA before any offering", "Reserve asset management + bankruptcy-remote segregation", "Redemption rights at par (EMT, T+1)", "S-EMT / S-ART thresholds (>€5B / >10M holders) trigger ECB direct supervision + extra liquidity / cap rules", "Quarterly prudential reporting", "Capital requirements per Art. 35"],
      time: "12–24 months",
      cost: "€100K–€1M+ (capital + governance + legal)",
      alts: ["Pick a Member-State juri (FR / IE / LU / LT / MT) for actual issuance", "Liechtenstein TVTG (often faster pre-MiCA path with EEA passport)", "Outside EU: Singapore MAS PSA, Switzerland FINMA, Bermuda DABA"],
      authority: "EBA + ECB (for S-EMT/S-ART significant tokens) · ESMA + NCA per Member State (for ART) · Home NCA (for non-significant EMT)",
      xrplNote: "RLUSD is Ripple's USD-backed stablecoin on XRPL + Ethereum — the reference MiCA-EMT implementation. Uses the IOU/Trust Line model on XRPL. Issuer must be EMI or credit institution.",
      custodyNote: "Stablecoin on XRPL uses the IOU / Trust Line model: gateway holds reserve assets — custodial by definition. freeze and globalFreeze flags provide compliance controls (sanctions, redemption suspensions).",
      ...
      marketingRules: "Cannot pay interest or present the stablecoin as an investment (MiCA Art. 50 EMT, Art. 40 ART). Mandatory whitepaper disclaimers. No misleading stability claims. S-EMT restrictions on volume/velocity may be imposed by ECB. Adverts must highlight redemption rights and risk.",
      clientEligibility: "Passport across all EU-27 once EMT/ART authorisation granted. Enhanced due diligence on PEPs, FATF high-risk countries. Retail eligible but individual caps may apply for S-ART. Geo-blocking required outside EEA."
    },
    fr: {
    "regime": "MiCA EMT/ART (pan-EU) + ACPR licensing for fiat-backed e-money issuers + AMF supervision for ART issuance + Banque de France oversight on payment-system impact",
    "risk": "high",
    "licenses": [
      "ACPR EMI authorisation (or credit-institution status) — required for EMT issuers under MiCA Art. 48",
      "ART authorisation by ACPR (significant ART → ECB direct supervision)",
      "AMF whitepaper notification for distribution",
      "PSAN registration AMF (France, transitional under MiCA Art. 143)"
    ],
    "obligations": [
      "1:1 reserve in cash + HQLA (MiCA Art. 49 + ACPR prudential rules)",
      "Reserve segregation bankruptcy-remote",
      "Whitepaper filed with ACPR + AMF",
      "Quarterly reserve disclosure to ACPR",
      "No interest / yield to holders (MiCA Art. 50)",
      "S-EMT / S-ART thresholds → ECB + EBA direct supervision"
    ],
    "time": "12–24 months",
    "cost": "€100K–€1M+ (capital + governance + legal)",
    "alts": [
      "Liechtenstein TVTG (faster pre-MiCA path with EEA passport)",
      "Singapore MAS PSA",
      "Switzerland FINMA"
    ],
    "authority": "ACPR + AMF + Banque de France · ECB / EBA for significant tokens",
    "xrplNote": "RLUSD is the reference EMT-on-XRPL implementation. French issuers using XRPL would need ACPR EMI + AMF whitepaper notification.",
    "custodyNote": "Stablecoin on XRPL = IOU / Trust Line model: gateway is custodial by definition. freeze + globalFreeze flags align with French sanctions / gel des avoirs Tracfin orders.",
    "reportingFrequency": "Monthly reserve disclosure to ACPR · Quarterly prudential + liquidity reports · Annual audit · Immediate notification to ACPR + AMF on reserve composition changes · Tracfin filings on suspicious flows.",
    "marketingRules": "Cannot pay interest or present as investment (MiCA Art. 50). AMF rules + Loi SREN (2024) on financial influencer disclosures. Whitepaper disclaimers in French mandatory for retail distribution. Risk warnings prominent.",
    "clientEligibility": "Passport across EU-27 once granted. AMF / ACPR enhanced due diligence on PEPs + FATF high-risk countries. Retail eligible in France but ACPR consumer-protection rules apply (clear pre-contractual info, redemption rights)."
    },
    us: {
    ...
    il: {
      regime: "BoI + ISA joint oversight. Israeli framework for stablecoin issuance still emerging — fiat-pegged stablecoins likely fall under BoI payment systems supervision; non-fiat-referenced may fall under ISA.",
      risk: "med",
      licenses: ["BoI authorisation (payment / money services)", "CMISA RFSP if non-bank issuer", "ISA approval if asset-referenced (security-like)"],
      obligations: ["1:1 reserves required (per BoI guidance)", "Reserve attestation + redemption rights", "AML/KYC per IMPA", "Israeli capital controls + reporting"],
      time: "12–24 months",
      cost: "$500K–$2M (legal + capital + reserves)",
      alts: ["EU MiCA EMT", "Bermuda DABA", "Singapore MAS SCS"],
      authority: "BoI + ISA + CMISA"
    },
    id: {
      regime: "Bank Indonesia + OJK — stablecoin issuance not yet explicitly authorised. Fiat-pegged would require e-money licence (BI). Non-IDR stablecoins effectively blocked from domestic distribution.",
      risk: "high",
      licenses: ["BI Electronic Money Issuer licence (Penyelenggara Uang Elektronik)", "OJK approval likely required from 2025"],
      obligations: ["Local issuer required (no foreign-issued stablecoins for retail)", "1:1 IDR reserves on-shore", "Reserve segregation", "BI reporting + AML", "No yield/interest allowed"],
      time: "12–24 months (regulatory clarity pending)",
      cost: "Capital + IDR-onshore setup, $1M–$3M",
      alts: ["Singapore MAS SCS", "Hong Kong HKMA", "EU MiCA EMT"],
      authority: "Bank Indonesia + OJK"
    },
    gh: {
      regime: "No stablecoin framework. BoG warned (2018+) that crypto-assets including stablecoins are unregulated; pending VAPA may include EMT-style provisions. eCedi (CBDC) project is BoG's official digital-currency focus.",
      risk: "high",
      licenses: ["No stablecoin licensing path today", "BoG sandbox potentially open for pilots", "Future VAPA EMT-equivalent licence"],
      obligations: ["AML per Act 1044 if any custody/distribution", "Sanctions screening", "Foreign-issued stablecoins not bank-distributable in Ghana"],
      time: "12–24+ months (regulatory clarity pending)",
      cost: "$200K–$800K (sandbox + legal)",
      alts: ["EU MiCA EMT", "South Africa FSCA stablecoin work", "Bermuda DABA"],
      authority: "Bank of Ghana (lead)"
    },
    cm: {
      regime: "BEAC ban prohibits stablecoin issuance and circulation as a means of payment in the CEMAC zone. CFA franc convertibility rules + foreign exchange controls add a second layer of constraint.",
      risk: "high",
      licenses: ["No stablecoin issuance path"],
      obligations: ["BEAC ban compliance", "BEAC FX controls on CFA convertibility", "ANTIC awareness notices"],
      time: "n/a",
      cost: "Legal/structuring offshore $50K–$200K",
      alts: ["Nigeria post-2023 reopening", "Mauritius VASP", "EU MiCA"],
      authority: "BEAC + COBAC"
    },
    ar: {
      regime: "No bespoke stablecoin licence yet — Law 27.739 brings issuers under PSAV scope when they distribute to Argentine residents. ARS-pegged stablecoins face strict BCRA FX controls; foreign-currency stablecoins (USDC/USDT) widely used as inflation hedge.",
      risk: "med",
      licenses: ["CNV PSAV registration if distributor", "BCRA notification (FX impact)", "UIF AML"],
      obligations: ["1:1 reserves for any peg claim", "AML per UIF Res. 49/2024", "BCRA Communication 'A' 7506 — banking restrictions", "Tax reporting (AFIP) on issuance + redemption"],
      time: "9–18 months",
      cost: "$300K–$1M (capital + legal)",
      alts: ["EU MiCA EMT", "Bermuda DABA", "Brazil BCB"],
      authority: "CNV + BCRA + UIF"
    },
    sv: {
      regime: "LEAD (Jan 2023) — non-Bitcoin stablecoin issuers register as digital-asset issuers under CNAD. Bitcoin holds dual legal-tender status; USD is the local fiat currency, simplifying USD-pegged stablecoin distribution.",
      risk: "med",
      licenses: ["CNAD digital-asset issuer registration", "Whitepaper filing (LEAD Art. 9)", "BSP if Bitcoin-pegged"],
      obligations: ["1:1 reserve disclosure (LEAD Art. 11)", "Reserve attestation + audit", "Local issuer or registered branch", "AML per CNAD rules"],
      time: "6–12 months",
      cost: "$200K–$800K",
      alts: ["Bahamas DARE Act", "Bermuda DABA", "EU MiCA EMT"],
      authority: "CNAD + BCR"
    }
  },
  ...
  custody: {
    eu: {
      regime: "MiCA — Title V Art. 75 (custody and administration of crypto-assets on behalf of clients)",
      risk: "high",
      licenses: ["CASP authorisation with custody scope under MiCA", "Passport across all EU-27 once granted"],
      obligations: ["Strict client-asset segregation (Art. 75(7))", "Client agreement specifying rights + liabilities (Art. 75(2))", "Liability for loss of clients' crypto-assets (Art. 75(8))", "ICT risk + cybersecurity (DORA, applicable from Jan 2025)", "Insurance / capital coverage proportional to assets under custody", "Quarterly reporting to home NCA", "ICT third-party risk management"],
      time: "9–18 months",
      cost: "€150K–€700K (capital + insurance + ICT)",
      alts: ["Pick a Member-State juri (FR / IE / LU / LT) for actual licensing", "Outside EU: Switzerland FINMA DLT custody, Liechtenstein TVTG TT Service Provider (faster, EEA passport)", "Bermuda DABA"],
      authority: "ESMA (level-2 standards) + national competent authorities (NCAs) per Member State",
      xrplNote: "On XRPL: SignerList majority + Single Key + IOU gateway models = custodial under MiCA Art. 75. Multi-sig SignerList (minority service participation) + non-custodial wallets = outside Art. 75 scope. MPC/TSS = grey zone (Art. 75 likely applies if service can sign alone).",
      custodyNote: "MiCA Art. 75 captures any service that 'safekeeps or controls' crypto-assets on behalf of a client. The 'control' criterion is decisive on XRPL: holding the master key, being able to sign alone, or controlling an issuing gateway = custodial. SignerList minority + Escrow + Payment Channels = no Art. 75 trigger.",
      reportingFrequency: "Quarterly prudential reports + custody-specific filings to home NCA · Annual audited accounts · ICT/DORA incident reports immediate · Monthly AML · Annual conflict-of-interest review.",
      marketingRules: "Must disclose custody model + liability scope + insurance coverage (MiCA Art. 75(2)+(8)). No misleading 'cold-storage 100%' or 'fully insured' unless verifiable. Risk warnings mandatory.",
      clientEligibility: "Passport across all EU-27 once granted. Custody for retail and professional clients allowed. Enhanced due diligence for PEPs / FATF high-risk countries. No suitability test for plain custody, but onboarding KYC mandatory."
    },
    fr: {
    "regime": "MiCA Art. 75 (custody and administration) + AMF as French NCA + ACPR for prudential aspects + DORA from January 2025",
    "risk": "high",
    "licenses": [
      "CASP authorisation with custody scope (AMF supervision)",
      "PSAN registration AMF (France, transitional under MiCA Art. 143 — auto-converts to CASP)",
      "ACPR fit-and-proper review on senior management"
    ],
    "obligations": [
      "Strict client-asset segregation (MiCA Art. 75(7) + AMF guidance)",
      "Liability for loss of clients' crypto-assets (Art. 75(8))",
      "Cybersecurity per AMF + ACPR + DORA standards",
      "Tracfin AML reporting on suspicious flows",
      "Insurance proportional to AUM (AMF expectation: ~10% of AUM)",
      "Quarterly prudential report to AMF + ACPR"
    ],
    "time": "9–18 months (AMF + ACPR coordinated review)",
    "cost": "€150K–€700K (capital + insurance + ICT)",
    "alts": [
      "Pick another EU Member-State CASP (LT cheapest, IE / LU institutional)",
      "Switzerland FINMA DLT custody",
      "Liechtenstein TVTG TT Service Provider"
    ],
    "authority": "AMF (lead) + ACPR (prudential) · ESMA level-2 standards",
    "xrplNote": "On XRPL: Single Key + IOU gateway = custodial under MiCA Art. 75 + PSAN. SignerList minority = outside Art. 75 scope. AMF doesn't yet have published guidance on multi-sig — written legal opinion recommended.",
    "custodyNote": "AMF Doctrine 2020-07 + 2023 update interprets PSAN custody scope. MiCA Art. 75 is now the primary regime; PSAN is transitional. Both cover wallet operators with control over private keys.",
    "reportingFrequency": "Quarterly prudential + custody-specific reports to AMF + ACPR · Annual audited accounts · DORA incident reports (immediate) · Monthly Tracfin AML · Annual conflict-of-interest review.",
    "marketingRules": "Disclosure of custody model + liability scope + insurance coverage (MiCA Art. 75(2)+(8)). AMF Code monétaire et financier rules on misleading communication (no 'fully insured' or '100% cold' claims unless verifiable). Loi SREN influencer rules apply.",
    "clientEligibility": "Passport across EU-27. Retail and professional clients allowed. AMF expectation: enhanced KYC for >€1K transfers (TFR Reg. 2023/1113). PEPs / FATF high-risk EDD."
    },
    us: {
    ...
    il: {
      regime: "Financial Services Regulation Law 2016 — crypto custody falls within CMISA scope as a regulated financial service.",
      risk: "med",
      licenses: ["CMISA RFSP licence (custody-of-financial-assets sub-category)", "IMPA registration", "ISA approval if security tokens"],
      obligations: ["Asset segregation (client vs proprietary)", "Insurance / fidelity bond", "Cyber-security per Israeli National Cyber Directorate guidelines", "KYC/AML", "Annual audit"],
      time: "9–15 months",
      cost: "$200K–$700K",
      alts: ["Dubai DFSA", "Switzerland FINMA DLT", "EU CASP via Liechtenstein TVTG"],
      authority: "CMISA + IMPA"
    },
    id: {
      regime: "Bappebti — custody by PFAKs is built into the licence; transitioning to OJK 2025. Customer assets must be held in CFX-supervised storage.",
      risk: "med",
      licenses: ["Bappebti PFAK with custody scope", "Bappebti-approved cold storage operator (Pengelola Tempat Penyimpanan Aset Kripto)", "OJK from 2025"],
      obligations: ["≥70% cold storage requirement", "CFX-supervised wallets", "Daily reconciliation reports to Bappebti", "Local data hosting (Indonesia)", "AML per Bappebti + PPATK reporting"],
      time: "9–15 months",
      cost: "Part of PFAK setup ($6M paid-up + custody infra)",
      alts: ["Singapore MAS DPT custody", "Dubai VARA", "Australia ASIC"],
      authority: "Bappebti + PPATK (transitioning to OJK)"
    },
    gh: {
      regime: "No dedicated custody licence today. Sandbox admission required for live custody pilots; banks prohibited from holding crypto for clients. VAPA (draft) expected to introduce a custody category aligned with FATF R.15.",
      risk: "high",
      licenses: ["BoG/SEC sandbox custody pilot", "FIC Ghana AML registration", "Future VAPA custody licence"],
      obligations: ["Asset segregation (best practice, not statutory)", "Cold-storage requirements (sandbox-specific)", "Insurance recommended", "AML per Act 1044"],
      time: "6–12 months (sandbox) · 18+ months (VAPA)",
      cost: "$200K–$800K",
      alts: ["South Africa FSCA Crypto Custody", "Mauritius VASP", "Switzerland FINMA DLT"],
      authority: "Bank of Ghana + SEC Ghana + FIC Ghana"
    },
    cm: {
      regime: "No custody licence available — BEAC ban prevents banks and licensed institutions from holding crypto assets. Self-custody legal but commercial custody business effectively blocked.",
      risk: "high",
      licenses: ["No custody licence path"],
      obligations: ["No banking interaction with crypto custody", "ANTIC scrutiny on commercial offerings", "Self-custody only"],
      time: "n/a",
      cost: "Offshore restructuring $50K–$200K",
      alts: ["Nigeria CBN-regulated DACS", "South Africa FSCA", "Switzerland FINMA"],
      authority: "BEAC + COBAC"
    },
    ar: {
      regime: "Custody falls within PSAV scope under Law 27.739 — CNV-registered custodians must segregate client assets and meet capital and operational standards.",
      risk: "med",
      licenses: ["CNV PSAV (custody scope)", "UIF AML", "Local incorporation OR registered branch"],
      obligations: ["Client/proprietary asset segregation", "Annual audit (PCGA)", "Insurance / operational risk policies", "BCRA reporting on FX-related crypto custody flows"],
      time: "6–12 months",
      cost: "$200K–$700K",
      alts: ["Brazil BCB", "Uruguay", "EU MiCA via Spain"],
      authority: "CNV + BCRA"
    },
    sv: {
      regime: "LEAD (Jan 2023) — custody is one of the licensable services under PSAD (non-Bitcoin) or BSP (Bitcoin). CNAD sets segregation, reserves and operational standards.",
      risk: "med",
      licenses: ["CNAD PSAD custody scope", "BSP if Bitcoin custody only"],
      obligations: ["Asset segregation (LEAD Art. 14)", "Cold-storage policy", "Insurance / proof-of-reserves", "USD-denominated reporting"],
      time: "6–12 months",
      cost: "$200K–$700K",
      alts: ["Bahamas DARE", "Bermuda DABA", "Switzerland FINMA"],
      authority: "CNAD + BCR"
    }
  },
  ...
  dapp_fin: {
    ...
    il: {
      regime: "ISA + CMISA case-by-case classification. Truly decentralised DeFi front-ends sit in a grey zone; centralised DeFi (CeFi) likely needs CMISA + ISA approval.",
      risk: "med",
      licenses: ["CMISA RFSP if controlling user funds", "ISA approval if dealing in security tokens", "IMPA registration"],
      obligations: ["KYC at fiat on/off-ramp", "Smart-contract audit", "Front-end terms-of-service", "Sanctions screening"],
      time: "6–12 months (case-by-case)",
      cost: "$100K–$400K legal",
      alts: ["Switzerland FINMA DLT", "Liechtenstein TVTG", "Singapore MAS"],
      authority: "ISA + CMISA + IMPA"
    },
    id: {
      regime: "Bappebti / OJK — DeFi not explicitly authorised. Central operator faces PFAK requirements; truly decentralised in legal grey zone.",
      risk: "high",
      licenses: ["Bappebti PFAK if identifiable operator", "Offshore structure typical (Singapore, Cayman)"],
      obligations: ["KYC/AML if centralised", "Geo-blocking sometimes used", "Local incorporation if user-facing"],
      time: "9–18 months",
      cost: "$200K–$1M depending on structure",
      alts: ["Singapore MAS", "Cayman", "Dubai VARA"],
      authority: "Bappebti / OJK"
    },
    gh: {
      regime: "No DeFi-specific framework. SEC Ghana would treat tokenised financial services as securities; BoG concerned about systemic risk + consumer protection. Early-stage projects gravitate to the sandbox.",
      risk: "high",
      licenses: ["BoG/SEC sandbox if centralised operator identifiable", "FIC Ghana AML"],
      obligations: ["Sandbox restrictions on user numbers + flows", "AML per Act 1044 if fiat on/off-ramp", "Consumer-protection disclosures"],
      time: "9–15 months",
      cost: "$100K–$500K",
      alts: ["South Africa FSCA", "Switzerland FINMA DLT", "Singapore MAS"],
      authority: "BoG + SEC Ghana + FIC Ghana"
    },
    cm: {
      regime: "DeFi front-ends face BEAC ban scope when any payment functionality routes through CEMAC banking rails. Truly decentralised infra in heavy grey zone — domestic legal exposure remains.",
      risk: "high",
      licenses: ["No DeFi authorisation path"],
      obligations: ["BEAC ban compliance", "ANTIC scrutiny on consumer-facing front-ends", "Geo-block recommended"],
      time: "n/a",
      cost: "Offshore structuring $100K–$400K",
      alts: ["Singapore MAS", "Switzerland FINMA", "Cayman + offshore foundation"],
      authority: "BEAC + ANTIC"
    },
    ar: {
      regime: "Centralised DeFi operators serving Argentine residents likely fall under PSAV — Law 27.739 catches any provider 'organising' crypto transactions for Argentine users. Decentralised front-ends in grey zone but CNV's reach is broadly defined.",
      risk: "med",
      licenses: ["CNV PSAV if identifiable operator", "UIF AML", "Offshore structure common"],
      obligations: ["KYC/AML if controlling user funds", "Geo-blocking sometimes used", "Consumer-protection notices in Spanish"],
      time: "6–12 months",
      cost: "$100K–$400K",
      alts: ["Uruguay", "Switzerland FINMA", "Cayman"],
      authority: "CNV + UIF"
    },
    sv: {
      regime: "LEAD applies a 'service-based' approach — anyone offering financial services on digital assets to Salvadoran residents needs CNAD authorisation. Decentralised protocols benefit from a more pragmatic CNAD posture compared to Argentina.",
      risk: "med",
      licenses: ["CNAD PSAD if operator identifiable", "BSP if Bitcoin DeFi"],
      obligations: ["KYC/AML if controlling funds", "Whitepaper filing for token offerings", "Localised disclosures (Spanish)"],
      time: "6–12 months",
      cost: "$100K–$400K",
      alts: ["Panama", "Bahamas DARE", "Switzerland FINMA"],
      authority: "CNAD"
    }
  },
  ...
  dapp_util: {
    ...
    fr: {
    "regime": "Outside MiCA scope (no crypto-asset financial element) — RGPD + CNIL data-protection law + Loi pour une République Numérique apply. Loi SREN (2024) covers online platform obligations.",
    "risk": "low",
    "licenses": [
      "No crypto-specific licence",
      "ANSSI cybersecurity declaration if critical infrastructure",
      "Loi SREN registration if online platform >5M monthly users"
    ],
    "obligations": [
      "RGPD + CNIL declarations + DPO appointment",
      "Loi SREN influencer + platform transparency rules",
      "Consumer Code (Code de la consommation) if B2C",
      "DSA reporting if user-generated-content platform"
    ],
    "time": "1–3 months",
    "cost": "€10K–€50K",
    "alts": [
      "Pick another EU Member-State for incorporation (IE / LU)",
      "Outside EU: UK GDPR-aligned, Singapore PDPA"
    ],
    "authority": "CNIL (data) · ANSSI (cybersecurity) · DGCCRF (consumer protection) · ARCOM (audiovisual / SREN platforms)",
    "xrplNote": "Pure utility XRPL DApps (governance, identity, social) outside crypto financial regulation. Adding tokens with monetary value triggers MiCA + PSAN analysis."
    },
    us: {
    ...
    ng: { regime: "SEC Nigeria DASP only if financial element; pure utility DApps generally outside scope", risk: "low", licenses: ["No licence for pure utility", "DASP if tokenised financial service"], obligations: ["Consumer protection", "Data protection per NDPR"], time: "1–3 months", cost: "NGN 10M–50M ($10K–$50K)", alts: ["UAE", "UE MiCA"], authority: "SEC Nigeria (only if VA)" },
    ke: { regime: "VASP Act 2025 — utility DApps outside scope unless financial service", risk: "low", licenses: ["No licence for pure utility", "CMA VASP if financial element"], obligations: ["Consumer protection", "DPA 2019 data protection"], time: "1–3 months", cost: "KES 2M–10M ($15K–$75K)", alts: ["UAE VARA", "Afrique du Sud"], authority: "CMA (only if VA)" },
    za: { regime: "FSCA only if financial; otherwise POPIA + consumer protection apply", risk: "low", licenses: ["No CASP for pure utility", "CASP Cat 1 if financial element"], obligations: ["POPIA data protection", "Consumer protection"], time: "1–3 months", cost: "ZAR 200K–1M ($12K–$55K)", alts: ["UAE VARA"], authority: "FSCA (only if VA)" },
    lu: { regime: "MiCA light — pure utility DApps typically outside scope", risk: "low", licenses: ["No CASP for pure utility", "CSSF CASP if financial"], obligations: ["GDPR", "Consumer protection"], time: "1–3 months", cost: "€20K–€100K", alts: ["Liechtenstein TVTG", "Switzerland"], authority: "CSSF (only if financial)" },
    ky: { regime: "Pure utility outside VASP Act — generally unregulated", risk: "low", licenses: ["No VASP for pure utility"], obligations: ["Data protection (DPA 2017)", "AML if token transfers"], time: "1–3 months", cost: "$20K–$80K — 0% corporate tax", alts: ["BVI", "Liechtenstein"], authority: "N/A" },
    ca: { regime: "Generally outside CSA/FINTRAC if pure utility — Canadian Privacy Act applies", risk: "low", licenses: ["No licence for pure utility", "FINTRAC MSB if token transfers > threshold"], obligations: ["PIPEDA privacy", "Consumer protection"], time: "1–3 months", cost: "C$50K–C$200K", alts: ["US", "EU"], authority: "N/A (privacy commissioners)" },
    vg: { regime: "Pure utility outside VASP Act — generally unregulated", risk: "low", licenses: ["No VASP for pure utility"], obligations: ["BVI Data Protection Act 2021", "AML if token transfers"], time: "1–3 months", cost: "$20K–$80K — 0% corporate tax", alts: ["Cayman", "Liechtenstein"], authority: "N/A" },
    au: { regime: "ASIC only if financial product; Privacy Act 1988 applies otherwise", risk: "low", licenses: ["No AFSL for pure utility", "ASIC AFSL if financial product"], obligations: ["Australian Privacy Principles", "Australian Consumer Law"], time: "1–3 months", cost: "A$50K–A$200K", alts: ["Singapore", "UAE"], authority: "N/A (privacy commissioner)" },
    mt: { regime: "MiCA light — pure utility DApps outside scope; GDPR applies", risk: "low", licenses: ["No CASP for pure utility", "MFSA CASP if financial"], obligations: ["GDPR", "Consumer protection"], time: "1–3 months", cost: "€20K–€80K", alts: ["Liechtenstein TVTG", "Lithuania"], authority: "MFSA (only if financial)" },
    bm: { regime: "Pure utility outside DABA — Bermuda Digital Asset Act sandbox available if novel", risk: "low", licenses: ["No DABA for pure utility", "DABA Class M (sandbox) if novel model"], obligations: ["PIPA data protection", "Consumer protection"], time: "1–3 months", cost: "BMD 30K–100K", alts: ["Cayman", "BVI"], authority: "N/A" },
    lt: { regime: "MiCA light — pure utility outside scope; GDPR applies", risk: "low", licenses: ["No CASP for pure utility", "Lietuvos bankas CASP if financial"], obligations: ["GDPR", "Lithuania Consumer Protection"], time: "1–3 months", cost: "€15K–€60K", alts: ["Malta MiCA", "Liechtenstein"], authority: "N/A (only if financial)" },
    ie: { regime: "MiCA light — pure utility outside scope; GDPR + Irish Data Protection Act apply", risk: "low", licenses: ["No CBI CASP for pure utility", "CBI CASP if financial element"], obligations: ["GDPR + Data Protection Act 2018", "Consumer Protection Code (CBI)"], time: "1–3 months", cost: "€40K–€150K", alts: ["Luxembourg", "Malta"], authority: "N/A (only if financial)" },
    il: {
      regime: "Outside crypto financial scope when truly utility-only. Israeli consumer protection + privacy law (PPL) apply.",
      risk: "low",
      licenses: ["No crypto-specific licence for pure utility DApps", "Israeli company registration"],
      obligations: ["Consumer protection compliance", "PPL data privacy (similar to GDPR)", "ISA notification only if any tokenised value transferred"],
      time: "1–3 months",
      cost: "$10K–$50K",
      alts: ["UAE DMCC Free Zone", "EU under MiCA exemptions"],
      authority: "ISA (only if VA element)"
    },
    id: {
      regime: "No crypto licence for pure utility DApps; treated as software products. Indonesian data protection law (UU PDP, 2022) applies.",
      risk: "low",
      licenses: ["No licence required for utility-only DApp"],
      obligations: ["UU PDP data protection", "Consumer protection", "Bappebti notification only if any virtual asset element"],
      time: "1–3 months",
      cost: "IDR 100M–500M ($6K–$30K)",
      alts: ["Singapore (no licence for utility)", "UAE DMCC"],
      authority: "Kominfo (Ministry of Communications) — only if app/service"
    },
    gh: {
      regime: "Pure utility DApps without crypto-asset element fall outside BoG / SEC Ghana scope. Data Protection Act 2012 + Cybersecurity Act 2020 still apply; sandbox optional for early-stage pilots.",
      risk: "low",
      licenses: ["No crypto-specific licence", "Cybersecurity Authority certification (case-by-case)"],
      obligations: ["Data Protection Act 2012 compliance", "Cybersecurity Act 2020 incident reporting", "Consumer-protection law"],
      time: "1–3 months",
      cost: "$10K–$50K",
      alts: ["South Africa", "Mauritius", "EU GDPR-aligned framework"],
      authority: "Cybersecurity Authority + Data Protection Commission"
    },
    cm: {
      regime: "Utility-only DApps not within BEAC ban scope. Cameroon Cybersecurity Law 2010 + Personal Data Protection Law 2024 apply. ANTIC supervises ICT-side compliance.",
      risk: "low",
      licenses: ["No crypto licence", "ANTIC ICT registration if telecom-adjacent"],
      obligations: ["Personal Data Protection Law 2024", "ANTIC notification if .cm domain or local hosting"],
      time: "1–3 months",
      cost: "$10K–$30K",
      alts: ["Senegal/Côte d'Ivoire", "Mauritius"],
      authority: "ANTIC"
    },
    ar: {
      regime: "Pure utility DApps outside crypto financial scope. Law 25.326 (data protection, GDPR-aligned) + Consumer Defence Law 24.240 apply. No CNV registration unless tokens involved.",
      risk: "low",
      licenses: ["No crypto licence required"],
      obligations: ["Law 25.326 data protection", "Consumer Defence Law 24.240", "Spanish-language T&Cs"],
      time: "1–3 months",
      cost: "$10K–$50K",
      alts: ["Uruguay", "Spain (EU)", "Mexico"],
      authority: "AAIP (data protection) + Consumer Defence Secretariat"
    },
    sv: {
      regime: "Utility-only DApps outside LEAD scope. Salvadoran Personal Data Protection Law (2021) + Consumer Defence Law apply. Generally crypto-friendly environment.",
      risk: "low",
      licenses: ["No crypto licence required"],
      obligations: ["Personal Data Protection Law", "Consumer Defence Law", "Local registration if commercial"],
      time: "1–3 months",
      cost: "$10K–$30K",
  ...
  nft: {
    ...
    fr: {
    "regime": "MiCA Recital 10 / Art. 2(3) (unique NFTs out of scope) + AMF case-by-case review for fractional / financial NFTs + Loi SREN (2024) for marketplace platforms + Code monétaire et financier",
    "risk": "med",
    "licenses": [
      "No MiCA licence for genuinely-unique 1/1 NFT collections",
      "PSAN / CASP if marketplace controls funds OR if NFT is fungible / financial (AMF reviews)",
      "AMF visa if security-NFT (rare)",
      "Loi SREN platform registration if >5M monthly users"
    ],
    "obligations": [
      "Code de la propriété intellectuelle (copyright + IP)",
      "Tracfin AML if marketplace handles fiat",
      "AMF doctrine 2022 on NFT financial classification",
      "Code de la consommation for B2C",
      "VAT treatment per BOFiP (CJUE Hedqvist precedent)"
    ],
    "time": "3–9 months",
    "cost": "€30K–€200K",
    "alts": [
      "Pick another EU Member-State (IE / LU / MT) for marketplace",
      "Outside EU: UK FCA, Singapore MAS, Switzerland FINMA"
    ],
    "authority": "AMF (financial NFT classification) · CNIL (data) · DGCCRF (consumer) · ARCOM (SREN platforms)",
    "xrplNote": "XRPL XLS-20 NFT broker mode = non-custodial atomic swap — marketplace can avoid PSAN / CASP for the trade itself. Custody / royalty management may still trigger PSAN."
    },
    us: {
    ...
    il: {
      regime: "ISA + CMISA on case-by-case. Pure collectible NFTs typically out-of-scope. Fractional / yield-bearing NFTs likely securities under Securities Law 1968.",
      risk: "med",
      licenses: ["No licence for pure collectibles", "ISA approval if fractional / financial NFT", "CMISA RFSP if marketplace controls funds"],
      obligations: ["Israeli copyright + IP law", "AML per IMPA if marketplace", "Consumer protection"],
      time: "3–9 months",
      cost: "$30K–$200K",
      alts: ["Switzerland FINMA", "Dubai VARA", "Singapore MAS"],
      authority: "ISA (financial NFTs) + IMPA"
    },
    id: {
      regime: "Bappebti / OJK case-by-case. NFTs as digital assets fall outside Bappebti's explicit list (which targets fungibles); fractional NFTs may need OJK after 2025.",
      risk: "med",
      licenses: ["No specific NFT licence", "Bappebti PFAK if fractional/financial element", "Local marketplace registration with Kominfo"],
      obligations: ["Indonesian IP law + UU PDP", "AML if marketplace handles fiat", "Tax: 0.1% on NFT sales (income tax + VAT)"],
      time: "3–9 months",
      cost: "$50K–$300K",
      alts: ["Singapore MAS", "Dubai VARA", "EU MiCA exemption"],
      authority: "Kominfo + Bappebti / OJK"
    },
    gh: {
      regime: "No NFT-specific framework. Pure collectibles likely outside SEC Ghana scope; financial / fractional NFTs would be securities. Sandbox available for marketplace pilots.",
      risk: "med",
      licenses: ["No licence for pure collectibles", "BoG/SEC sandbox for fractional / financial NFT", "FIC Ghana AML if marketplace"],
      obligations: ["Copyright Act 2005", "AML if marketplace handles fiat", "Consumer-protection disclosures"],
      time: "3–9 months",
      cost: "$30K–$200K",
      alts: ["South Africa", "EU MiCA exemption", "Singapore MAS"],
      authority: "SEC Ghana + Copyright Office"
    },
    cm: {
      regime: "Pure NFTs (collectibles) outside BEAC ban scope when not used as means of payment. Financial / fractional NFTs would clash with the ban; commercial marketplaces blocked from CEMAC banking.",
      risk: "high",
      licenses: ["No marketplace licence available"],
      obligations: ["Copyright + IP law", "ANTIC supervision", "No fiat banking rail"],
      time: "n/a (commercial path blocked)",
      cost: "Offshore structuring $50K–$200K",
      alts: ["Nigeria", "Senegal", "EU MiCA exemption"],
      authority: "ANTIC + BEAC"
    },
    ar: {
      regime: "CNV case-by-case classification. Pure NFTs typically outside PSAV scope; fractional / yield-bearing NFTs likely securities under Law 26.831 (Capital Markets Law).",
      risk: "med",
      licenses: ["No PSAV for pure collectibles", "CNV PSAV if fractional / financial NFT", "UIF AML"],
      obligations: ["Copyright Law 11.723", "AML if fiat on/off-ramp", "AFIP tax reporting (income + VAT)"],
      time: "3–9 months",
      cost: "$30K–$200K",
      alts: ["Brazil BCB", "Uruguay", "EU MiCA exemption"],
      authority: "CNV + UIF"
    },
    sv: {
      regime: "LEAD covers all digital assets including NFTs in commerce. Pure collectibles benefit from light-touch CNAD scrutiny; marketplaces handling user funds need PSAD.",
      risk: "med",
      licenses: ["No PSAD for pure collectibles", "CNAD PSAD if marketplace controls funds"],
      obligations: ["IP law", "AML per CNAD if marketplace", "Whitepaper if utility/financial NFT"],
      time: "3–9 months",
      cost: "$30K–$200K",
      alts: ["Panama", "Bahamas DARE", "EU MiCA exemption"],
      authority: "CNAD"
    }
  },
  ...
  mpt: {
    ...
    fr: {
    "regime": "MiCA — MPT (XLS-33, live 2025) classified case-by-case as Other crypto-asset, EMT, or ART. AMF case-by-case via doctrine + pre-launch consultation. ACPR if EMT-like.",
    "risk": "med",
    "licenses": [
      "MiCA whitepaper notified to AMF (Art. 8)",
      "EMT or ART authorisation (ACPR / AMF) if features qualify",
      "PSAN / CASP for distribution (transitional under Art. 143)"
    ],
    "obligations": [
      "Whitepaper + use-case disclosure (filed with AMF)",
      "AMF pre-launch consultation recommended for hybrid features",
      "Reserve transparency if asset-backed",
      "Marketing per category rules",
      "Tracfin reporting"
    ],
    "time": "6–18 months",
    "cost": "€100K–€500K",
    "alts": [
      "Pick another EU Member-State (LT for fast notification)",
      "Switzerland FINMA DLT",
      "Liechtenstein TVTG (Token Container Model fits MPT well)"
    ],
    "authority": "AMF (lead) · ACPR (if EMT-like) · ESMA level-2 standards",
    "xrplNote": "MPT (XLS-33) activated on Mainnet 2025. AMF has not yet published MPT-specific doctrine — pre-launch consultation strongly advised. lsfRequireAuth flag aligns with French AML expectations."
    },
    us: {
    ...
    ng: { regime: "SEC Nigeria DASP + potential CBN oversight — classification per use", risk: "med", licenses: ["SEC Nigeria DASP", "CBN approval if payment element"], obligations: ["KYC/AML per MLPPA", "Classification disclosure"], time: "9–18 months", cost: "NGN 200M–500M ($200K–$500K)", alts: ["UAE VARA", "UE MiCA"], authority: "SEC Nigeria + CBN" },
    ke: { regime: "VASP Act 2025 — classification per use (payment/utility/security)", risk: "med", licenses: ["CMA VASP + classification-specific requirements"], obligations: ["KYC/AML per POCAMLA", "3% Digital Asset Tax"], time: "6–12 months", cost: "KES 5M–30M ($40K–$230K)", alts: ["UAE VARA", "South Africa"], authority: "CMA" },
    za: { regime: "FSCA CASP + classification per use under FAIS", risk: "med", licenses: ["CASP Category I or II depending on use", "CISCA if pooled investment"], obligations: ["FICA AML + Travel Rule", "Classification disclosure"], time: "6–12 months", cost: "ZAR 1M–5M ($55K–$275K)", alts: ["UAE VARA", "Mauritius"], authority: "FSCA + FIC" },
    lu: { regime: "MiCA — classification per function (Utility/EMT/ART); Luxembourg flexible on token-container designs", risk: "high", licenses: ["CASP if service provision", "EMI if fiat-backed", "MiCA ART authorisation if asset-referenced"], obligations: ["Legal qualification required before launch", "Whitepaper", "KYC/AML", "lsfRequireAuth allows on-chain KYC gating", "lsfLocked allows AML holds"], time: "6–18 months", cost: "€50K–€400K", alts: ["Liechtenstein TVTG (flexible token container)", "Switzerland FINMA"], authority: "CSSF", xrplNote: "MPT (XLS-33) is XRPL's programmable-token standard. No explicit MiCA category yet. lsfRequireAuth = on-chain KYC gating. lsfLocked = AML holds. Programmable transfer fees. Legal qualification critical before launch." },
    ky: { regime: "Cayman VASP Act — classification per dominant feature", risk: "med", licenses: ["CIMA VASP as issuer / exchange depending on role", "Cayman Foundation Company commonly used"], obligations: ["AML + MLRO", "Legal qualification disclosure"], time: "3–9 months", cost: "$50K–$250K — 0% corporate tax", alts: ["BVI", "Liechtenstein"], authority: "CIMA" },
    ca: { regime: "CSA case-by-case classification — Staff Notice 46-307/308 analysis per MPT design", risk: "high", licenses: ["CSA prospectus if security-like", "FINTRAC MSB if custody/transfer", "IIROC if investment dealer"], obligations: ["Classification analysis + disclosure", "KYC/AML"], time: "9–18 months", cost: "C$200K–C$800K", alts: ["US SAFT/Reg D", "EU MiCA"], authority: "CSA" },
    vg: { regime: "BVI VASP Act + SIBA depending on classification", risk: "med", licenses: ["BVI VASP + SIBA if hybrid features", "BVI Foundation for community tokens"], obligations: ["AML + MLRO", "Classification disclosure"], time: "3–9 months", cost: "$50K–$250K — 0% corporate tax", alts: ["Cayman VASP", "Liechtenstein"], authority: "BVI FSC" },
    au: { regime: "ASIC INFO 225 — classification per token function; most MPT trigger AFSL", risk: "high", licenses: ["ASIC AFSL per classification", "AUSTRAC DCE if exchange element", "ASIC Digital Asset Platform 2026"], obligations: ["DDO + classification disclosure", "KYC/AML per AML/CTF Act"], time: "9–18 months", cost: "A$200K–A$800K", alts: ["Singapore MAS", "UAE VARA"], authority: "ASIC" },
    mt: { regime: "MiCA — classification per function via MFSA", risk: "high", licenses: ["MFSA CASP + classification-specific licences", "EMI if fiat-backed"], obligations: ["Legal qualification required", "Whitepaper", "KYC/AML"], time: "6–12 months", cost: "€50K–€300K", alts: ["Lithuania MiCA", "Luxembourg"], authority: "MFSA" },
    bm: { regime: "DABA Class F/M — classification per function", risk: "med", licenses: ["DABA Class F + supplementary BMA approval for novel MPT"], obligations: ["AML/ATF per POCA", "BMA Cyber Risk Management Code"], time: "6–12 months", cost: "BMD 100K–350K", alts: ["Cayman VASP", "BVI"], authority: "BMA" },
    lt: { regime: "MiCA — classification per function via Lietuvos bankas", risk: "high", licenses: ["Lietuvos bankas CASP + classification-specific requirements", "EMI if fiat-backed"], obligations: ["Legal qualification required", "Whitepaper", "KYC/AML"], time: "6–12 months", cost: "€50K–€250K", alts: ["Malta MiCA", "Luxembourg"], authority: "Lietuvos bankas" },
    ie: { regime: "MiCA — classification per function via CBI", risk: "high", licenses: ["CBI CASP + classification-specific licences", "EMI if fiat-backed", "MiFID investment firm if security-like"], obligations: ["Legal qualification required per CJA 2010", "Whitepaper", "KYC/AML", "DORA operational resilience"], time: "9–15 months", cost: "€150K–€500K", alts: ["Luxembourg CSSF", "Malta MFSA"], authority: "Central Bank of Ireland (CBI)" },
    il: {
      regime: "ISA classification depends on programmable terms. MPT with yield / pooled value likely security under Securities Law 1968. Pure utility MPT case-by-case.",
      risk: "med",
      licenses: ["ISA approval likely required (security characteristics)", "CMISA RFSP if issued by non-bank", "IMPA registration"],
      obligations: ["Disclosure regime depending on classification", "AML/KYC", "Capital requirements per CMISA tier"],
      time: "9–18 months",
      cost: "$150K–$600K",
      alts: ["Switzerland FINMA DLT", "EU MiCA via TVTG", "Singapore MAS"],
      authority: "ISA + CMISA"
    },
    id: {
      regime: "Bappebti / OJK — MPT with multiple uses needs case-by-case approval. Programmable features may trigger OJK securities-style oversight from 2025.",
      risk: "med",
      licenses: ["Bappebti notification minimum", "OJK approval likely from 2025 for hybrid features", "PFAK if traded on a platform"],
      obligations: ["Token whitepaper + use-case disclosure", "Reserve transparency if asset-backed", "AML per PPATK"],
      time: "9–15 months",
      cost: "$100K–$500K",
      alts: ["Singapore MAS", "Dubai VARA", "EU MiCA"],
      authority: "Bappebti / OJK"
    ...
    gh: {
      regime: "No MPT-specific framework — would fall under draft VAPA when enacted. SEC Ghana would case-by-case classify based on programmable terms (utility vs investment).",
      risk: "high",
      licenses: ["BoG/SEC sandbox for live MPT pilots", "Future VAPA licence", "FIC Ghana AML"],
      obligations: ["Whitepaper + use-case disclosure", "AML per Act 1044", "Sandbox-specific reporting"],
      time: "9–18 months",
      cost: "$100K–$500K",
      alts: ["South Africa FSCA", "Singapore MAS", "Switzerland FINMA"],
      authority: "SEC Ghana + BoG"
    },
    cm: {
      regime: "MPT use as payment means falls under BEAC ban; pure utility MPT in heavy grey zone with no licensing path. Issuance to Cameroonian residents not authorised.",
      risk: "high",
      licenses: ["No MPT issuance path"],
      obligations: ["BEAC ban compliance", "ANTIC scrutiny"],
      time: "n/a",
      cost: "Offshore structuring",
      alts: ["Mauritius VASP", "Singapore MAS", "EU MiCA"],
      authority: "BEAC + ANTIC"
    },
    ar: {
      regime: "CNV case-by-case under Law 27.739 + Capital Markets Law 26.831 — programmable tokens with investment characteristics treated as securities. Pure utility MPT likely needs PSAV registration.",
      risk: "med",
      licenses: ["CNV PSAV (issuer scope)", "Capital Markets Law authorisation if security-like", "UIF AML"],
      obligations: ["Whitepaper + risk disclosure", "Reserve transparency if asset-backed", "AML per UIF Res. 49/2024"],
      time: "9–15 months",
      cost: "$100K–$500K",
      alts: ["Brazil BCB", "Uruguay", "EU MiCA Other crypto-asset"],
      authority: "CNV + UIF"
    },
    sv: {
      regime: "LEAD treats MPT as a digital asset — issuance requires CNAD registration with whitepaper. Programmable features generally accommodated due to El Salvador's pragmatic stance.",
      risk: "med",
      licenses: ["CNAD digital-asset issuer registration", "Whitepaper filing"],
      obligations: ["Whitepaper (LEAD Art. 9)", "Disclosure of programmable features", "AML per CNAD"],
      time: "6–12 months",
      cost: "$100K–$400K",
      alts: ["Bahamas DARE", "Bermuda DABA", "EU MiCA"],
      authority: "CNAD"
    }
  },
  ...
  rwa: {
    ...
    il: {
      regime: "ISA — Securities Law 1968 applies; tokenised real-world assets are typically securities requiring full prospectus or accredited-investor exemption (Section 15A).",
      risk: "high",
      licenses: ["ISA prospectus filing OR Section 15A private placement (≤35 investors / accredited only)", "CMISA RFSP for issuer / platform", "BoI for fiat settlement"],
      obligations: ["Full prospectus disclosure", "Underlying asset valuation + custody", "Investor protection (Section 22A)", "Annual reporting"],
      time: "12–24 months",
      cost: "$500K–$2M (prospectus + legal + audit)",
      alts: ["EU DLT Pilot Regime", "Switzerland FINMA DLT", "Liechtenstein TVTG"],
      authority: "ISA + CMISA"
    },
    id: {
      regime: "OJK (from 2025) — RWAs almost certainly fall under securities regulation. Currently a grey zone; Bappebti only authorises commodities, not securities.",
      risk: "high",
      licenses: ["OJK securities prospectus + issuer licence", "Local SRO membership (e.g. KSEI)", "BI for IDR fiat leg"],
      obligations: ["Prospectus + audited financials", "Custody by KSEI-recognised custodian", "Local incorporation", "Quarterly reporting"],
      time: "12–24 months",
      cost: "$500K–$2M",
      alts: ["Singapore MAS DLT pilot", "Switzerland FINMA DLT", "EU DLT Pilot Regime"],
      authority: "OJK (from 2025) + Bank Indonesia"
    },
    gh: {
      regime: "Real-world asset tokenisation untested — SEC Ghana would treat as a securities offering under the Securities Industry Act 2016 (Act 929). Sandbox is the only realistic on-ramp pre-VAPA.",
      risk: "high",
      licenses: ["SEC Ghana prospectus filing OR private-placement exemption", "BoG/SEC sandbox", "Local custodian arrangement"],
      obligations: ["Prospectus disclosure", "Underlying-asset valuation + custody", "Investor-protection rules (SIA 2016)", "Annual reporting"],
      time: "12–24 months",
      cost: "$300K–$1.5M",
      alts: ["South Africa FSCA", "Mauritius VASP", "Switzerland FINMA DLT"],
      authority: "SEC Ghana + BoG"
    },
    cm: {
      regime: "RWA tokenisation cuts across BEAC ban + CEMAC securities regime (CMAC supervision). No domestic path; offshore structuring only.",
      risk: "high",
      licenses: ["No domestic RWA licence"],
      obligations: ["BEAC ban compliance", "CMAC securities scrutiny if any CEMAC investor"],
      time: "n/a",
      cost: "Offshore structuring $300K–$1M",
      alts: ["Mauritius VASP", "Switzerland FINMA DLT", "Liechtenstein TVTG"],
      authority: "BEAC + CMAC"
    },
    ar: {
      regime: "CNV under Capital Markets Law 26.831 + Law 27.739 — RWA tokens are securities requiring full prospectus or accredited-investor exemption. BCRA FX controls add complexity for foreign-currency-denominated RWAs.",
      risk: "high",
      licenses: ["CNV prospectus + securities issuer registration", "BCRA FX clearance", "UIF AML"],
      obligations: ["Full prospectus disclosure", "Underlying-asset audit + custody", "AFIP tax reporting", "BCRA capital-controls compliance"],
      time: "12–24 months",
      cost: "$300K–$1.5M",
      alts: ["Brazil BCB DLT pilot", "Uruguay", "EU DLT Pilot Regime"],
      authority: "CNV + BCRA + UIF"
    },
    sv: {
      regime: "LEAD explicitly contemplates RWA issuance. CNAD-registered issuers can tokenise real-world assets with whitepaper filing — significantly faster than Argentina or Ghana. Bitcoin Volcano Bonds set the precedent.",
      risk: "med",
      licenses: ["CNAD digital-asset issuer registration", "Whitepaper filing (LEAD Art. 9)", "Local custodian or registered branch"],
      obligations: ["Whitepaper + asset audit", "Reserve transparency", "Annual filings to CNAD", "USD-denominated reporting"],
      time: "6–12 months",
      cost: "$200K–$800K",
      alts: ["Switzerland FINMA DLT", "Liechtenstein TVTG", "Bermuda DABA"],
      authority: "CNAD + BCR"
    }
  },
  ...
  gaming: {
    ...
    ng: { regime: "National Lottery Regulatory Commission + SEC if financial element", risk: "med", licenses: ["NLRC gaming licence if gambling", "SEC DASP if investment element"], obligations: ["Player protection per NLRA 2005", "KYC/AML"], time: "6–12 months", cost: "NGN 100M–400M ($100K–$400K)", alts: ["UAE", "Malta"], authority: "NLRC + SEC Nigeria" },
    ke: { regime: "BCLB gaming licence if gambling + VASP Act if financial tokens", risk: "med", licenses: ["BCLB licence if gambling", "CMA VASP if financial tokens"], obligations: ["Player protection", "3% Digital Asset Tax on token gains"], time: "6–12 months", cost: "KES 5M–20M ($40K–$150K)", alts: ["UAE", "Malta"], authority: "BCLB + CMA" },
    za: { regime: "Provincial Gambling Board licence if gambling + FSCA CASP if financial", risk: "med", licenses: ["Provincial gambling licence (Gauteng/Western Cape)", "CASP if financial tokens"], obligations: ["Player protection", "Responsible gambling", "POPIA data protection"], time: "9–15 months", cost: "ZAR 2M–8M ($110K–$440K)", alts: ["UAE", "Malta"], authority: "Provincial GBs + FSCA" },
    lu: { regime: "MiCA Utility Token + Luxembourg Gambling Act if play-to-earn / betting element", risk: "low", licenses: ["No CASP if pure utility in-game", "Gambling Commission if betting/chance + reward", "EMI if fiat holding"], obligations: ["Player protection", "GDPR", "AML if gambling licence"], time: "3–9 months", cost: "€50K–€250K", alts: ["Malta Gaming Authority", "Liechtenstein"], authority: "CSSF + Gambling Commission" },
    ky: { regime: "Cayman VASP if financial tokens; no specific GameFi framework", risk: "low", licenses: ["CIMA VASP if financial element", "Cayman Foundation for game DAOs"], obligations: ["AML if VASP", "Data protection (DPA 2017)"], time: "3–6 months", cost: "$50K–$200K — 0% corporate tax", alts: ["BVI", "UAE"], authority: "CIMA" },
    ca: { regime: "AGCO (Ontario) / provincial gaming regulators + CSA if financial", risk: "high", licenses: ["Provincial gaming licence (AGCO etc.)", "CSA if token has investment character", "FINTRAC MSB if custody"], obligations: ["Player protection", "Responsible gambling", "KYC/AML"], time: "12–18 months", cost: "C$200K–C$800K", alts: ["US state-by-state", "UE Malta"], authority: "Provincial regulators + CSA" },
    vg: { regime: "BVI Gaming Act + VASP if financial tokens", risk: "low", licenses: ["BVI Gaming licence if gambling", "BVI VASP if financial tokens", "BVI Foundation for game DAOs"], obligations: ["AML + MLRO", "Player protection"], time: "3–6 months", cost: "$50K–$200K — 0% corporate tax", alts: ["Cayman", "Malta"], authority: "BVI Gaming Board + FSC" },
    au: { regime: "State gambling regulators + ASIC if financial-product element", risk: "med", licenses: ["State gambling licence (state-by-state)", "ASIC AFSL if financial product", "AUSTRAC DCE if token exchange"], obligations: ["Player protection", "Responsible gambling", "KYC/AML"], time: "12–18 months", cost: "A$200K–A$800K", alts: ["Singapore MAS", "UAE"], authority: "State regulators + ASIC" },
    mt: { regime: "MGA (Malta Gaming Authority) — one of world's leading gaming hubs + MiCA if financial tokens", risk: "low", licenses: ["MGA B2B/B2C gaming licence", "MFSA CASP if financial tokens"], obligations: ["Player protection", "Responsible gambling", "GDPR", "AML per MGA directives"], time: "6–12 months", cost: "€100K–€300K", alts: ["UAE VARA", "Lithuania"], authority: "MGA + MFSA" },
    bm: { regime: "Bermuda Gaming Commission + DABA if financial tokens", risk: "med", licenses: ["Bermuda Gaming Commission licence if gambling", "DABA Class F/M if financial tokens"], obligations: ["Player protection", "AML/ATF per POCA 1997"], time: "6–12 months", cost: "BMD 100K–300K", alts: ["Cayman", "Malta"], authority: "Gaming Commission + BMA" },
    lt: { regime: "Lithuania Gaming Control Authority + MiCA if financial tokens", risk: "low", licenses: ["Gaming Control Authority licence if gambling", "Lietuvos bankas CASP if financial tokens"], obligations: ["Player protection", "GDPR", "AML"], time: "4–9 months", cost: "€50K–€200K", alts: ["Malta", "Liechtenstein"], authority: "Gaming Authority + Lietuvos bankas" },
    ie: { regime: "Gaming and Lotteries Act + MiCA if financial tokens; Ireland's Gambling Regulation Act 2024 strengthening oversight", risk: "med", licenses: ["Irish Gaming licence (under Gambling Regulatory Authority, Jun 2025)", "CBI CASP if financial tokens"], obligations: ["Player protection per GR Act 2024", "GDPR", "AML per CJA 2010"], time: "9–15 months", cost: "€150K–€500K", alts: ["Malta MGA", "Lithuania"], authority: "Gambling Regulatory Authority + CBI" },
    il: {
      regime: "Israeli gambling law (Penal Law §224) prohibits most gambling. NFT gaming with monetisable items may trigger gambling provisions if chance-based.",
      risk: "high",
      licenses: ["No general gaming licence available in Israel (gambling largely illegal)", "ISA notification if NFT items are securities"],
      obligations: ["Avoid chance-based mechanics for Israeli users", "Geo-block from Israel if gambling-adjacent", "Consumer protection law"],
      time: "n/a (no licensing path for gambling)",
      cost: "Legal review $20K–$100K",
      alts: ["UK Gambling Commission", "Malta MGA", "France ANJ JONUM"],
      authority: "Ministry of Internal Security + ISA"
    },
    id: {
      regime: "Indonesian Penal Code prohibits gambling (Article 303). NFT/Web3 gaming with chance + monetisable rewards effectively blocked for Indonesian users.",
      risk: "high",
      licenses: ["No gaming licence available for chance-based crypto games", "Kominfo registration for game publishers"],
      obligations: ["Geo-block Indonesian IPs if gambling-adjacent", "UU PDP data privacy", "Consumer protection"],
      time: "n/a (gambling prohibited)",
      cost: "Legal review $30K–$150K",
      alts: ["Philippines PAGCOR", "Malta MGA", "Singapore MAS sandbox"],
      authority: "Kominfo + Indonesian National Police"
    },
    gh: {
      regime: "Gaming Act 2006 (Act 721) — Gaming Commission of Ghana licenses gambling. NFT/Web3 games with chance-based monetisation likely require gaming licence; pure skill or non-monetised play is exempt.",
      risk: "high",
      licenses: ["Gaming Commission of Ghana licence (chance-based)", "No specific Web3-gaming category"],
      obligations: ["Anti-gambling-addiction measures", "Age verification", "AML per Act 1044", "Tax on winnings (Withholding Tax 10%)"],
      time: "9–15 months",
      cost: "$100K–$400K",
    ...
    cm: {
      regime: "Gambling regulated by Loi 2017-022 + Casino Decree. Crypto/NFT gaming with monetisable items effectively blocked — both gambling licensing and BEAC ban apply.",
      risk: "high",
      licenses: ["No Web3 gaming licence available"],
      obligations: ["Geo-block Cameroon", "BEAC ban compliance", "Cameroon Penal Code §326-bis (gambling restrictions)"],
      time: "n/a",
      cost: "Legal review $30K–$150K",
      alts: ["Malta MGA", "Curaçao", "Philippines PAGCOR"],
      authority: "Ministry of Finance + BEAC + ANTIC"
    },
    ar: {
      regime: "Gambling regulated provincially (each Argentine province has its own framework — e.g., Buenos Aires LOTBA, Mendoza). NFT/Web3 games with chance need provincial licences; PSAV applies if monetisation routes through crypto.",
      risk: "high",
      licenses: ["Provincial gambling licence (per province operated)", "CNV PSAV if crypto rails", "UIF AML"],
      obligations: ["Provincial gambling rules (per jurisdiction)", "AML if crypto", "Consumer-protection law"],
      time: "12–18 months (per province)",
      cost: "$200K–$800K (multi-province aggregated)",
      alts: ["Malta MGA", "Curaçao", "Mexico SEGOB"],
      authority: "Provincial gambling commissions + CNV (crypto leg)"
    },
    sv: {
      regime: "Gambling regulated by Casino Law (1996) + Lotteries Act. Crypto-gaming pragmatic stance — Bitcoin/USD gaming acceptable provided gambling licence + LEAD-compliant token economy.",
      risk: "med",
      licenses: ["Salvador gambling licence (Ministerio de Hacienda)", "CNAD PSAD if NFT economy"],
      obligations: ["Gambling tax + AML per CNAD", "Age verification", "Local registration"],
      time: "9–15 months",
      cost: "$200K–$700K",
  ...
  payment: {
    ...
    fr: {
    "regime": "MiCA CASP transfer-service scope + PSD2 (becoming PSD3) for fiat leg + ACPR-licensed payment institution / EMI + AMF-supervised PSAN (transitional) + Banque de France oversight",
    "risk": "high",
    "licenses": [
      "CASP authorisation (AMF) for crypto transfer service",
      "ACPR EMI authorisation (EMD2 / EMD3) for e-money issuance",
      "ACPR Payment Institution authorisation (PSD2 / PSD3) for fiat payment services",
      "PSAN registration AMF (France, transitional under MiCA Art. 143)"
    ],
    "obligations": [
      "Customer fund segregation (PSD2 Art. 10 + ACPR rules)",
      "KYC/AML per AMLD6 + Code monétaire et financier + Tracfin reporting",
      "Travel Rule >€1K via TFR Reg. 2023/1113",
      "MiCA Art. 66 marketing + AMF anti-misleading rules",
      "Strong Customer Authentication (PSD2 SCA)",
      "Capital min. €350K (EMI) / €125K (CASP)"
    ],
    "time": "12–24 months (AMF + ACPR coordinated)",
    "cost": "€350K–€1M+ (capital + governance + dual-licence stack)",
    "alts": [
      "Pick another EU Member-State (LT for speed, IE / LU for institutional)",
      "Outside EU: UK FCA EMI, Singapore MAS MPI"
    ],
    "authority": "AMF + ACPR + Banque de France · ESMA / EBA level-2 standards",
    "xrplNote": "XRPL Payment Channels enable off-ledger settlement — no CASP for the channel itself but conversion to fiat at exit triggers ACPR EMI + AMF CASP. RLUSD is the EMT-compliant payment-token reference."
    },
    us: {
    ...
    il: {
      regime: "BoI + Payment Services Law 5779-2019 — crypto-payment providers regulated as payment service providers.",
      risk: "med",
      licenses: ["BoI Payment Services Provider licence (PSPSL)", "CMISA RFSP for crypto leg", "IMPA registration"],
      obligations: ["Customer fund segregation", "KYC/AML per IMPA", "Israeli ILS currency rules", "Consumer protection (Payment Services Law §29)"],
      time: "9–15 months",
      cost: "$200K–$700K",
      alts: ["EU MiCA + EMI passport", "UK FCA EMI", "Singapore MAS MPI"],
      authority: "BoI + CMISA + IMPA"
    },
    id: {
      regime: "Bank Indonesia — Payment Services regime (PJP) for crypto payment providers. PADG (BI Reg.) tightly controls non-bank payment services.",
      risk: "med",
      licenses: ["BI PJP (Penyelenggara Jasa Pembayaran) licence — Category 1 / 2 / 3 by activity", "Bappebti PFAK if crypto trading involved", "Local Indonesian incorporation"],
      obligations: ["IDR-onshore settlement", "Local data hosting", "BI reporting + STR to PPATK", "Customer fund segregation", "KYC per BI rules"],
      time: "9–15 months",
      cost: "IDR 50B–100B (~$3–6M) + setup",
      alts: ["Singapore MAS MPI", "Philippines BSP", "Australia AUSTRAC"],
      authority: "Bank Indonesia + Bappebti / OJK"
    },
    gh: {
      regime: "BoG Payment Systems and Services Act 2019 (Act 987) — payment service providers licensed under tiered scheme. No crypto-payment integration at retail level until VAPA passes; sandbox open for pilots.",
      risk: "high",
      licenses: ["BoG PSP licence (Tier 1/2/3)", "BoG/SEC sandbox for crypto leg", "FIC Ghana AML"],
      obligations: ["GHS-onshore settlement", "BoG reporting", "AML per Act 1044", "No bank-rail for crypto until VAPA"],
      time: "9–18 months",
      cost: "GHS 5M–20M (~$330K–$1.3M, capital tier-dependent)",
      alts: ["Nigeria CBN PSP + VASP", "South Africa FSCA", "Mauritius VASP"],
      authority: "Bank of Ghana + FIC Ghana"
    },
    cm: {
      regime: "BEAC Règlement 02/18 governs CEMAC payment systems. Crypto-payment provision blocked by BEAC May-2022 directive. Mobile money (MoMo) is the dominant rail.",
      risk: "high",
      licenses: ["No crypto-payment licence", "BEAC EME (Établissement de Monnaie Électronique) for fiat-only"],
      obligations: ["BEAC ban", "FX controls on CFA convertibility"],
      time: "n/a",
      cost: "EME setup $200K–$500K (fiat-only)",
      alts: ["Nigeria post-2023", "Senegal/Côte d'Ivoire — UEMOA zone", "Ghana sandbox"],
      authority: "BEAC + COBAC"
    },
    ar: {
      regime: "BCRA-regulated PSP (Proveedores de Servicios de Pago) regime. Crypto-payment intersection with PSAV (Law 27.739) — both required for fiat-crypto payment provider.",
      risk: "med",
      licenses: ["BCRA PSP licence (Communication 'A' 7641)", "CNV PSAV", "UIF AML"],
      obligations: ["ARS-onshore settlement", "BCRA Communication 'A' 7506 — banking restrictions", "AFIP transaction reporting", "Daily BCRA reporting on FX"],
      time: "9–15 months",
      cost: "$200K–$700K",
      alts: ["Uruguay", "Brazil BCB", "EU MiCA via Spain"],
      authority: "BCRA + CNV + UIF"
    },
    sv: {
      regime: "LEAD + Bitcoin Law combine to make crypto-payment provision relatively straightforward. PSAD or BSP licence depending on asset; BCR oversight on settlement aspects.",
      risk: "med",
      licenses: ["CNAD PSAD payment scope (non-Bitcoin)", "BSP if Bitcoin-payment", "Local incorporation"],
      obligations: ["KYC/AML per CNAD", "USD-denominated reporting", "Local director"],
      time: "6–12 months",
      cost: "$200K–$700K",
      alts: ["Panama", "Bahamas DARE", "EU MiCA EMI"],
      authority: "CNAD + BCR"
    }
  },
  ...
  onramp_offramp: {
    ...
    fr: {
    "regime": "MiCA Art. 75 (transfer-of-crypto-assets) + ACPR EMI / Payment Institution for fiat leg + AMF-supervised PSAN (transitional) + bank partnership for SEPA settlement + Tracfin enhanced reporting",
    "risk": "high",
    "licenses": [
      "CASP with on/off-ramp scope (AMF)",
      "ACPR EMI authorisation OR Payment Institution authorisation for fiat leg",
      "PSAN registration AMF (France, transitional under MiCA Art. 143)",
      "Bank partnership for SEPA settlement (Banque de France oversight)"
    ],
    "obligations": [
      "Strict KYC (AMLD6) + Tracfin reporting",
      "Source-of-funds for high-value transfers (AMF expectation: >€10K)",
      "Travel Rule >€1K (TFR Reg. 2023/1113)",
      "Customer fund segregation (PSD2 Art. 10)",
      "AMF + ACPR fit-and-proper on senior management",
      "Sanctions screening (UN + EU + France gel des avoirs)"
    ],
    "time": "12–24 months (AMF + ACPR + bank-onboarding)",
    "cost": "€500K–€1.5M (capital + IT/compliance + bank partnerships)",
    "alts": [
      "Pick another EU Member-State (LT cheapest)",
      "UAE VARA, Singapore MAS MPI"
    ],
    "authority": "AMF + ACPR + Banque de France · ESMA / EBA level-2 standards",
    "xrplNote": "XRPL ODL (On-Demand Liquidity) uses XRP as a bridge currency for fiat-to-fiat corridors. France-based ODL operators need CASP + Payment Institution + bank partnerships per corridor (EUR / GBP / USD)."
    },
    us: {
    ...
    il: {
      regime: "BoI Payment Services Law + AML Order 2018 (IMPA). Fiat-crypto on/off-ramps trigger payment services regulation + non-bank financial services (CMISA).",
      risk: "med",
      licenses: ["BoI Payment Services Provider", "CMISA RFSP (currency exchange / custody scope)", "IMPA registration", "Israeli bank partnership for ILS settlement"],
      obligations: ["Strict KYC including ID verification", "Source-of-funds for >₪50K", "Sanctions screening", "Daily ILS reporting to BoI"],
      time: "9–15 months",
      cost: "$200K–$600K",
      alts: ["EU MiCA EMI", "UAE VARA", "Singapore MAS MPI"],
      authority: "BoI + CMISA + IMPA"
    },
    id: {
      regime: "BI Payment Services + Bappebti PFAK. Fiat-crypto on/off-ramps require both: BI for fiat leg, Bappebti for crypto leg.",
      risk: "med",
      licenses: ["BI PJP licence (payment leg)", "Bappebti PFAK (crypto leg)", "Local bank partnership for IDR rails"],
      obligations: ["IDR-onshore only — no foreign currency settlement", "Strict KYC (e-KTP verification)", "Local data hosting", "PPATK STR reporting", "Daily reconciliation"],
      time: "12–18 months (dual licence)",
      cost: "$8M+ (combined PFAK + PJP capital + setup)",
      alts: ["Singapore MAS MPI", "Philippines BSP VASP", "Australia AUSTRAC"],
      authority: "Bank Indonesia + Bappebti / OJK"
    },
    gh: {
      regime: "Ghanaian banks restricted from crypto on/off-ramp until VAPA enacted. Mobile money rail (MTN MoMo, AirtelTigo Money) is the de facto channel via P2P platforms; BoG sandbox the only formal pilot path.",
      risk: "high",
      licenses: ["BoG sandbox for live operation", "Mobile-money agent partnership", "FIC Ghana AML"],
      obligations: ["Sandbox flow caps", "Strict KYC + ID-Card verification (Ghana Card)", "AML per Act 1044", "Sanctions screening"],
      time: "9–15 months (sandbox)",
      cost: "$200K–$700K",
      alts: ["Nigeria CBN-regulated DASP+VASP", "South Africa FSCA", "Mauritius VASP"],
      authority: "Bank of Ghana + FIC Ghana"
    },
    cm: {
      regime: "On/off-ramp blocked by BEAC ban — no compliant fiat-crypto rail. Mobile money + P2P operate informally; commercial provision exposes both operator and bank-partner.",
      risk: "high",
      licenses: ["No on/off-ramp licence available"],
      obligations: ["BEAC ban compliance", "ANTIC scrutiny"],
      time: "n/a",
      cost: "Offshore restructuring $50K–$200K",
      alts: ["Nigeria", "Ghana sandbox", "Senegal/Côte d'Ivoire — UEMOA zone"],
      authority: "BEAC + COBAC + ANTIC"
    },
    ar: {
      regime: "PSAV (Law 27.739) covers on/off-ramp. BCRA Communication 'A' 7506 limits direct bank exposure to crypto; ramps typically partner with non-bank PSPs or use stablecoin rails.",
      risk: "med",
      licenses: ["CNV PSAV (on/off-ramp scope)", "BCRA PSP if fiat leg", "UIF AML"],
      obligations: ["ARS-onshore settlement", "Strict KYC (DNI verification)", "BCRA FX-control reporting", "AFIP daily reporting"],
      time: "9–15 months",
      cost: "$300K–$900K",
      alts: ["Uruguay", "Brazil BCB", "EU via Spain"],
      authority: "CNV + BCRA + UIF"
    },
    sv: {
      regime: "LEAD + Bitcoin Law make on/off-ramp straightforward — Bitcoin legal-tender status removes a major friction; USD is local fiat. PSAD covers non-Bitcoin assets, BSP covers Bitcoin.",
      risk: "med",
      licenses: ["CNAD PSAD on/off-ramp scope", "BSP if Bitcoin-only", "Local bank partnership"],
      obligations: ["KYC per CNAD", "USD-denominated reporting", "AML"],
      time: "6–12 months",
      cost: "$200K–$600K",
      alts: ["Panama", "Bahamas DARE", "Mexico CNBV"],
      authority: "CNAD + BCR"
    }
  },
  ...
  cross_border_payment: {
    ...
    fr: {
    "regime": "MiCA CASP transfer + PSD2 (becoming PSD3) + PSR + TFR Reg. 2023/1113 (Travel Rule) + ACPR cross-border supervision + Banque de France FX reporting",
    "risk": "high",
    "licenses": [
      "CASP authorisation (AMF) — transfer-of-crypto-assets scope",
      "ACPR EMI or Payment Institution for fiat leg",
      "PSAN registration AMF (France, transitional under MiCA Art. 143)",
      "TFR Travel Rule technical infrastructure"
    ],
    "obligations": [
      "Travel Rule >€1K (TFR Reg. 2023/1113) — originator + beneficiary data",
      "Sanctions screening (UN + EU + France gel des avoirs Tracfin)",
      "AML monitoring (AMLD6 + EU AML Package + Tracfin)",
      "Customer fund segregation",
      "Banque de France FX reporting on cross-border flows >€10K",
      "Source-of-funds checks for high-value transfers"
    ],
    "time": "12–24 months (multi-regulator stack)",
    "cost": "€500K–€1.5M+ (capital + IT/compliance + Travel Rule infra)",
    "alts": [
      "Pick another EU Member-State (LT for speed)",
      "UAE DFSA / VARA, Singapore MAS MPI, UK FCA EMI"
    ],
    "authority": "AMF + ACPR + Banque de France · ESMA / EBA + EU AMLA from 2025",
    "xrplNote": "XRPL ODL (On-Demand Liquidity) — XRP as bridge currency for cross-border fiat corridors — is a flagship use case for French institutional cross-border crypto payments. Cross-Chain Bridge (XLS-38d, voting) extends to EVM Sidechain."
    },
    us: {
    ...
    il: {
      regime: "BoI Payment Services Law + Foreign Exchange Control Law 1978. Cross-border ILS movements tracked; crypto rails require enhanced reporting.",
      risk: "med",
      licenses: ["BoI Payment Services Provider", "BoI foreign-currency dealer authorisation", "IMPA registration", "Travel Rule compliance"],
      obligations: ["Travel Rule (FATF R.16) — sender + receiver data", "BoI capital-controls reporting", "Sanctions screening (UN + Israeli + OFAC)", "Annual audit"],
      time: "12–18 months",
      cost: "$300K–$800K",
      alts: ["UAE DFSA / VARA", "Singapore MAS MPI", "UK FCA EMI"],
      authority: "BoI + IMPA"
    },
    id: {
      regime: "Bank Indonesia — Cross-Border Payment Services regulated under PADG. Foreign-currency settlement tightly controlled.",
      risk: "high",
      licenses: ["BI PJP cross-border category", "Local bank partnership", "Bappebti PFAK if crypto leg"],
      obligations: ["Mandatory IDR conversion at point of receipt", "Local data hosting", "BI reporting on every transaction", "Travel Rule (PPATK)", "Source-of-funds per AML POJK"],
      time: "12–18 months",
      cost: "$5M+ (cross-border capital tier)",
      alts: ["Singapore MAS MPI", "Hong Kong HKMA", "Australia AUSTRAC"],
      authority: "Bank Indonesia + PPATK"
    },
    gh: {
      regime: "BoG Foreign Exchange Act 2006 + Payment Systems Act 2019. Cross-border crypto payment blocked at bank level until VAPA enacted; sandbox the only pilot path.",
      risk: "high",
      licenses: ["BoG sandbox for live operation", "FIC Ghana AML", "BoG cross-border PSP licence (fiat-only)"],
      obligations: ["Travel Rule (FATF R.16)", "BoG FX-control reporting", "Sanctions screening", "AML per Act 1044"],
      time: "12–18 months",
      cost: "$300K–$900K",
      alts: ["Nigeria CBN-regulated", "Mauritius VASP", "South Africa SARB"],
      authority: "Bank of Ghana + FIC Ghana"
    },
    cm: {
      regime: "Cross-border crypto payment fundamentally incompatible with BEAC ban + CFA franc FX controls. Mobile money cross-border (e.g., Cameroon ↔ Nigeria) operates within fiat rails only.",
      risk: "high",
      licenses: ["No cross-border crypto licence"],
      obligations: ["BEAC ban", "FX controls on CFA convertibility", "ANTIC scrutiny"],
      time: "n/a",
      cost: "Offshore structuring required",
      alts: ["UEMOA zone (Senegal, Côte d'Ivoire)", "Mauritius VASP", "Nigeria post-2023"],
      authority: "BEAC + COBAC"
    },
    ar: {
      regime: "BCRA strict FX controls (cepo cambiario) + PSAV Law 27.739. Cross-border crypto rails subject to high scrutiny; corridor flows often hit AFIP tax + BCRA cap on USD purchases.",
      risk: "high",
      licenses: ["CNV PSAV cross-border scope", "BCRA PSP", "UIF AML"],
      obligations: ["BCRA FX-control reporting (daily)", "Travel Rule (FATF R.16)", "AFIP tax (PAIS tax 30% on FX)", "Sanctions screening"],
      time: "12–18 months",
      cost: "$500K–$1.5M",
      alts: ["Uruguay (lighter FX)", "Brazil BCB", "EU via Spain"],
      authority: "BCRA + CNV + UIF"
    },
    sv: {
      regime: "LEAD + Bitcoin Law make cross-border crypto payment a flagship use case — El Salvador positions itself as remittance hub. Chivo Wallet pioneered Bitcoin remittances. CNAD oversight on non-Bitcoin assets.",
      risk: "med",
      licenses: ["CNAD PSAD cross-border", "BSP if Bitcoin", "Local incorporation"],
      obligations: ["Travel Rule (FATF R.16)", "USD-denominated reporting to BCR", "AML per CNAD"],
      time: "6–12 months",
      cost: "$200K–$700K",
      alts: ["Panama", "Bahamas DARE", "Mexico CNBV"],
      authority: "CNAD + BCR"
  ...
  token_utility: {
    ...
    fr: {
    "regime": "MiCA Title II (Other crypto-assets, Art. 4+) — utility tokens. AMF as French NCA — whitepaper notification (no full authorisation). Loi SREN (2024) for influencer + marketing rules.",
    "risk": "med",
    "licenses": [
      "MiCA whitepaper notified to AMF (Art. 8) — no AMF approval required, just notification",
      "PSAN / CASP for distribution / trading (transitional under Art. 143)",
      "Already-traded exemption (Art. 4(2)) for established tokens"
    ],
    "obligations": [
      "Whitepaper meeting Annex I (description, rights, risks, tokenomics) — filed with AMF",
      "12-month liability for whitepaper accuracy (Art. 14)",
      "Marketing must be consistent with whitepaper (Art. 7) + AMF anti-misleading rules",
      "No yield / investment promises",
      "French translation mandatory if marketing in France",
      "Loi SREN influencer disclosures"
    ],
    "time": "3–9 months (notification path)",
    "cost": "€50K–€300K (legal + drafting + AMF filing fees)",
    "alts": [
      "Pick another EU Member-State (LT cheapest)",
      "Outside EU: Switzerland FINMA (utility category), Liechtenstein TVTG, Singapore MAS Other Token"
    ],
    "authority": "AMF (notification-based) · ESMA level-2 standards",
    "xrplNote": "XRPL utility tokens via IOU / Trust Lines or new MPT (XLS-33) standard. MPT's lsfRequireAuth aligns with French AML expectations + AMF compliance-gating doctrine."
    },
    us: {
    ...
    il: {
      regime: "ISA — Securities Law 1968 case-by-case. Pure utility tokens with current immediate use typically out-of-scope; speculative or yield-bearing tokens are securities.",
      risk: "med",
      licenses: ["ISA notification or no-action letter", "Section 15A private placement if accredited only", "CMISA RFSP if platform-issued"],
      obligations: ["Non-investment-character disclosure", "Marketing restrictions (no yield language)", "AML if traded"],
      time: "3–9 months (notification) or 12+ (full prospectus)",
      cost: "$50K–$300K",
      alts: ["Switzerland FINMA (utility category)", "Liechtenstein TVTG", "EU MiCA Other crypto-asset"],
      authority: "ISA"
    },
    id: {
      regime: "Bappebti — utility tokens may need to be on the approved list (~229 tokens) to be tradable on PFAKs. OJK from 2025 may add securities-style scrutiny.",
      risk: "med",
      licenses: ["Bappebti list inclusion application", "OJK approval from 2025 for higher-scrutiny tokens"],
      obligations: ["Token whitepaper + utility-only justification", "Bappebti review (CDDC criteria)", "AML if traded on PFAK"],
      time: "6–12 months",
      cost: "$50K–$200K",
      alts: ["Singapore MAS", "Dubai VARA", "Switzerland FINMA"],
      authority: "Bappebti / OJK"
    },
    gh: {
      regime: "No utility-token specific framework. SEC Ghana would case-by-case classify; pure utility likely outside Securities Industry Act 2016 scope. Sandbox available for live offerings.",
      risk: "med",
      licenses: ["BoG/SEC sandbox for offering", "FIC Ghana AML if traded", "Future VAPA notification"],
      obligations: ["Whitepaper", "Marketing restrictions (no investment language)", "AML if traded"],
      time: "3–9 months (sandbox) · 12+ months (full path)",
      cost: "$50K–$300K",
      alts: ["Switzerland FINMA (utility category)", "Mauritius VASP", "EU MiCA Other crypto-asset"],
      authority: "SEC Ghana + BoG"
    },
    cm: {
      regime: "Utility token issuance to Cameroonian residents not authorised under BEAC ban when token has any payment functionality. Pure non-payment utility tokens in heavy grey zone — no formal authorisation route.",
      risk: "high",
      licenses: ["No utility-token issuance path"],
      obligations: ["BEAC ban compliance", "ANTIC scrutiny on marketing"],
      time: "n/a",
      cost: "Offshore structuring",
      alts: ["Mauritius VASP", "Switzerland FINMA", "EU MiCA"],
      authority: "BEAC + ANTIC"
    },
    ar: {
      regime: "CNV case-by-case under Law 27.739 + Capital Markets Law 26.831. Pure utility tokens likely need PSAV registration when offered to Argentine residents; speculative or yield-bearing tokens treated as securities.",
      risk: "med",
      licenses: ["CNV PSAV (issuer scope)", "Capital Markets exemption if private", "UIF AML"],
      obligations: ["Whitepaper + non-investment-character disclosure", "Marketing restrictions", "AML if traded"],
      time: "6–12 months",
      cost: "$100K–$400K",
      alts: ["Uruguay", "Brazil BCB", "Mexico"],
      authority: "CNV + UIF"
    },
    sv: {
      regime: "LEAD light-touch on utility tokens — CNAD whitepaper filing rather than full prospectus. Pragmatic stance, faster than Argentina or Ghana.",
      risk: "med",
      licenses: ["CNAD digital-asset issuer registration", "Whitepaper filing (LEAD Art. 9)"],
      obligations: ["Whitepaper", "Marketing restrictions (no investment promise)", "AML per CNAD"],
      time: "3–9 months",
      cost: "$50K–$300K",
      alts: ["Bahamas DARE", "Bermuda DABA", "EU MiCA Other crypto-asset"],
      authority: "CNAD"
    }
  },
  ...
  token_security: {
    eu: {
      regime: "Prospectus Regulation (EU 2017/1129) + MiFID II (Dir. 2014/65) — security tokens are out-of-scope for MiCA (Art. 2(4)(a)) and fall under classic securities law. DLT Pilot Regime (Reg. 2022/858) provides a sandbox for tokenised securities trading + settlement.",
      risk: "high",
      licenses: ["Prospectus approved by home NCA (or exemption: <€8M, <150 retail investors, qualified-investors-only)", "MiFID II investment-firm authorisation if intermediating", "DLT Pilot Regime market-infrastructure licence (DLT MTF / DLT SS / DLT TSS) for tokenised-securities trading venues"],
      obligations: ["Full prospectus disclosure (Annexes I-VI of Reg. 2017/1129)", "Audited financial statements (3 years)", "Ongoing transparency obligations (Transparency Directive 2004/109)", "Insider trading / market abuse rules (MAR Reg. 596/2014)", "MiFID II suitability + appropriateness if retail-distributed", "DLT Pilot caps: total market cap <€1B per issuer for shares, <€500M for bonds"],
      time: "12–24 months (full prospectus) · 6–9 months (DLT Pilot or exemption-based)",
      cost: "€500K–€2M (prospectus + legal + audit + listing)",
      alts: ["Pick a Member-State juri (FR / IE / LU / DE) for actual issuance", "Outside EU: Switzerland FINMA DLT Act, Liechtenstein TVTG, US Reg D / Reg S, Singapore MAS"],
      authority: "ESMA (level-2 standards) + national securities regulators (e.g. AMF, BaFin, CSSF, CMVM) for prospectus approval",
      xrplNote: "Tokenised securities on XRPL typically use the IOU / Trust Line model (issuer-controlled) or the upcoming MPT (XLS-33) for programmable compliance flags (lsfRequireAuth = on-chain KYC). DLT Pilot Regime explicitly allows DLT-based settlement — XRPL technically eligible.",
      reportingFrequency: "Continuous disclosure of inside information (MAR Art. 17) · Annual financial report · Half-year report · Quarterly trading-statement (where applicable) · Major-shareholding notifications (Transparency Dir. Art. 9).",
      marketingRules: "Prospectus mandatory unless exemption. No advertising before prospectus approved. Promotional material must be consistent with prospectus + clearly identifiable as marketing (Art. 22 Reg. 2017/1129). MiFID II rules on inducements + best execution apply to intermediaries.",
      clientEligibility: "Retail-eligible if full prospectus + MiFID II suitability. Qualified-investors-only path skips prospectus (Art. 1(4)(a)). Geographical scope = EEA passporting via host-NCA notification."
    },
    fr: {
    "regime": "Out of MiCA (Art. 2(4)(a)) — Prospectus Regulation (EU 2017/1129) + MiFID II + AMF Visa for prospectus approval + DLT Pilot Regime (Reg. 2022/858) sandbox available",
    "risk": "high",
    "licenses": [
      "AMF Visa on prospectus (or exemption: <€8M, <150 retail per Member State, qualified-investors-only)",
      "MiFID II investment-firm authorisation (ACPR + AMF if intermediating)",
      "DLT Pilot Regime market-infrastructure licence (DLT MTF / DLT SS / DLT TSS)",
      "AIFMD authorisation if vault structure qualifies as collective investment"
    ],
    "obligations": [
      "Full prospectus disclosure with AMF Visa (Annexes I-VI of Reg. 2017/1129)",
      "Audited financials (3 years)",
      "Transparency Directive 2004/109",
      "Insider trading rules (MAR Reg. 596/2014) + AMF doctrine",
      "DLT Pilot caps: market cap <€1B per issuer for shares, <€500M for bonds",
      "MiFID II suitability if retail-distributed"
    ],
    "time": "12–24 months (AMF visa) · 6–9 months (DLT Pilot or exemption)",
    "cost": "€500K–€2M (prospectus + legal + audit + listing)",
    "alts": [
      "Pick another EU Member-State (IE / LU for institutional, DE for industrial scale)",
      "Outside EU: Switzerland FINMA DLT Act, Liechtenstein TVTG, US Reg D / Reg S"
    ],
    "authority": "AMF (visa + supervision) · ACPR if banking element · ESMA level-2 · Euronext if listed",
    "xrplNote": "Tokenised securities on XRPL typically use IOU / Trust Line (issuer-controlled) or upcoming Single Asset Vault (XLS-72, proposed). DLT Pilot Regime explicitly allows DLT settlement — XRPL technically eligible."
    },
    us: {
    ...
    il: {
      regime: "ISA — Securities Law 1968 fully applies. Token offerings are securities offerings; full prospectus or Section 15A exemption required.",
      risk: "high",
      licenses: ["ISA prospectus filing", "OR Section 15A private placement (≤35 investors / accredited only)", "ISA-licensed underwriter", "TASE listing if public market"],
      obligations: ["Full prospectus disclosure", "Audit + ongoing reporting", "Insider trading + disclosure rules", "Annual report", "Sukar / proxy obligations"],
      time: "12–24 months",
      cost: "$500K–$2M (prospectus + legal + audit)",
      alts: ["EU Prospectus + DLT Pilot", "Switzerland FINMA", "Liechtenstein TVTG"],
      authority: "ISA + Tel Aviv Stock Exchange (TASE) if listed"
    },
    id: {
      regime: "OJK (from 2025) — security tokens fall under securities law. Currently in transition: Bappebti only handles commodity-like tokens.",
      risk: "high",
      licenses: ["OJK prospectus + securities issuer licence", "KSEI custody arrangement", "Local SRO membership"],
      obligations: ["OJK prospectus disclosure", "Indonesian-incorporated issuer", "Quarterly + annual reporting", "Auditor required"],
      time: "12–24 months",
      cost: "$500K–$2M",
      alts: ["Singapore MAS", "Switzerland FINMA", "EU Prospectus Regulation"],
      authority: "OJK (from 2025)"
    },
    gh: {
      regime: "Securities Industry Act 2016 (Act 929) fully applies — token offerings are securities offerings. SEC Ghana prospectus or accredited-investor exemption required.",
      risk: "high",
      licenses: ["SEC Ghana prospectus filing", "OR private-placement exemption (sophisticated investors only)", "BoG/SEC sandbox optional for live testing"],
      obligations: ["Full prospectus disclosure", "Audit + ongoing reporting", "Insider trading rules", "Annual report"],
      time: "12–24 months",
      cost: "$300K–$1.5M",
      alts: ["South Africa FSCA", "Mauritius", "Switzerland FINMA"],
      authority: "SEC Ghana"
    },
    cm: {
      regime: "CMAC (Commission de Surveillance du Marché Financier de l'Afrique Centrale) regulates CEMAC securities. Tokenised securities face combined CMAC + BEAC scrutiny — practically blocked.",
      risk: "high",
      licenses: ["No domestic security-token path"],
      obligations: ["CMAC + BEAC ban", "Offshore structuring required"],
      time: "n/a",
      cost: "Offshore $300K–$1M",
      alts: ["Mauritius", "Switzerland FINMA", "EU Prospectus Regulation"],
      authority: "BEAC + CMAC"
    },
    ar: {
      regime: "CNV under Capital Markets Law 26.831 + Law 27.739 — security-token offerings are securities offerings. Full prospectus or accredited-investor exemption (Reg. S equivalent).",
      risk: "high",
      licenses: ["CNV prospectus + securities issuer registration", "Accredited-investor exemption (Reg. S)", "Underwriter (CNV-licensed)", "BYMA listing if public market"],
      obligations: ["Full prospectus disclosure", "Audit + ongoing reporting", "Insider trading + disclosure rules", "Annual report (form CNV)"],
      time: "12–24 months",
      cost: "$300K–$1.5M",
      alts: ["Brazil B3 + BCB", "Uruguay", "EU Prospectus Regulation"],
      authority: "CNV + BYMA"
    },
    sv: {
      regime: "LEAD covers tokenised securities — CNAD-supervised path with whitepaper filing instead of full prospectus. Volcano Bonds (BTC-backed sovereign bonds) demonstrated the framework in practice.",
      risk: "med",
      licenses: ["CNAD digital-asset issuer registration", "Whitepaper filing (LEAD Art. 9)", "Local custodian"],
      obligations: ["Whitepaper + audit", "Annual reporting to CNAD", "Investor-protection disclosures"],
      time: "6–12 months",
      cost: "$200K–$800K",
      alts: ["Switzerland FINMA", "Liechtenstein TVTG", "Bermuda DABA"],
      authority: "CNAD"
    }
  },
  ...
  token_hybrid: {
    ...
    fr: {
    "regime": "MiCA case-by-case classification + AMF doctrine on hybrid tokens + ACPR if EMT-like + Prospectus Regulation if security-like. Multi-licence stack typical.",
    "risk": "high",
    "licenses": [
      "MiCA whitepaper at minimum (filed with AMF — Other crypto-asset)",
      "EMT or ART authorisation (ACPR) if features qualify",
      "AMF Visa on prospectus if classified as security (out of MiCA)",
      "PSAN / CASP for distribution (transitional under Art. 143)"
    ],
    "obligations": [
      "Full disclosure of all features in whitepaper (AMF expectation)",
      "Cannot frame as 'utility' if security-like behaviour present (AMF doctrine)",
      "12-month liability for whitepaper accuracy",
      "Marketing must reflect dominant classification (no mixed messaging) + Loi SREN influencer rules",
      "Quarterly + annual reporting"
    ],
    "time": "9–18 months (multi-regulator coordination)",
    "cost": "€300K–€1M (multi-licence stack)",
    "alts": [
      "Pick another EU Member-State (LT / IE / LU)",
      "Switzerland FINMA (more flexible on hybrid classification), Liechtenstein TVTG (Token Container Model fits hybrids well)"
    ],
    "authority": "AMF (lead) + ACPR (if EMT) + ESMA / EBA · level-2 standards",
    "xrplNote": "MPT (XLS-33) is purpose-built for hybrid tokens — programmable flags allow per-token compliance behaviour. French issuers should map each MPT flag to its MiCA classification implication + run AMF pre-launch consultation."
    },
    us: {
    ...
    il: {
      regime: "ISA applies the strictest reading — hybrid tokens with any investment characteristic treated as securities under Section 1 (Howey-like test).",
      risk: "high",
      licenses: ["ISA prospectus + CMISA RFSP", "Section 15A if private", "Multi-licence stack likely"],
      obligations: ["Full disclosure", "Cannot use 'utility' framing if ISA classifies as security", "Annual + interim reports"],
      time: "15–24 months",
      cost: "$700K–$2M+",
      alts: ["Switzerland FINMA (more flexible)", "Liechtenstein TVTG (Token Container Model)", "Dubai VARA"],
      authority: "ISA + CMISA"
    },
    id: {
      regime: "Bappebti / OJK case-by-case — hybrid tokens with investment features will likely fall under OJK securities oversight from 2025.",
      risk: "high",
      licenses: ["Bappebti list inclusion + OJK approval likely required", "Multi-regulator filings"],
      obligations: ["Full disclosure of hybrid features", "Indonesian-incorporated issuer", "Quarterly reports"],
      time: "12–24 months",
      cost: "$500K–$1.5M",
      alts: ["UAE VARA", "Switzerland FINMA", "EU MiCA"],
      authority: "Bappebti + OJK"
    },
    gh: {
      regime: "No hybrid-token framework. SEC Ghana strict reading — any investment characteristic likely triggers Securities Industry Act 2016 securities classification.",
      risk: "high",
      licenses: ["SEC Ghana prospectus + sandbox (parallel)", "FIC Ghana AML"],
      obligations: ["Full disclosure", "Cannot use 'utility' framing if SEC classifies as security", "Annual + interim reports"],
      time: "15–24 months",
      cost: "$500K–$1.5M",
      alts: ["South Africa FSCA", "Switzerland FINMA (more flexible)", "Mauritius"],
      authority: "SEC Ghana"
    },
    cm: {
      regime: "Hybrid tokens face combined BEAC ban + CMAC securities scrutiny. No path; offshore structuring + geo-blocking required.",
      risk: "high",
      licenses: ["No domestic path"],
      obligations: ["BEAC ban + CMAC scrutiny", "Geo-block recommended"],
      time: "n/a",
      cost: "Offshore $500K–$1M",
      alts: ["Mauritius", "Switzerland FINMA", "EU MiCA"],
      authority: "BEAC + CMAC"
    },
    ar: {
      regime: "CNV + UIF apply strictest reading — hybrid tokens with any investment characteristic classified as securities. Multi-licence stack typically required.",
      risk: "high",
      licenses: ["CNV prospectus + PSAV", "Capital Markets exemption if private", "UIF AML"],
      obligations: ["Full disclosure", "Cannot frame as utility if security characteristics", "Quarterly + annual reporting"],
      time: "15–24 months",
      cost: "$500K–$1.5M",
      alts: ["Uruguay", "Brazil BCB", "EU MiCA"],
      authority: "CNV + UIF"
    },
    sv: {
      regime: "LEAD pragmatic on hybrid tokens — CNAD whitepaper accommodates multi-feature tokens with risk disclosures. Significantly faster than Argentina or Ghana for the same product.",
      risk: "med",
      licenses: ["CNAD digital-asset issuer registration", "Whitepaper filing (LEAD Art. 9)"],
      obligations: ["Whitepaper with hybrid-feature disclosure", "Annual reporting to CNAD", "USD-denominated"],
      time: "6–12 months",
      cost: "$200K–$800K",
      alts: ["Bahamas DARE", "Bermuda DABA", "Switzerland FINMA"],
      authority: "CNAD"
