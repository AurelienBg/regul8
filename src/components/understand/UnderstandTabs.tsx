...
const TABS: TabDef[] = [
  ...
  { key: 'xrpl', href: '/understand/xrpl', match: (p: string) => p.startsWith('/understand/xrpl') || p.startsWith('/learn/xrpl') || p.startsWith('/xrpl'), icon: <XRPLMark className="w-4 h-4 text-xrpl" />, labelEn: 'XRPL', labelFr: 'XRPL' },
