  ...
  return (
    <>
      ...
      <aside
        ...
        aria-modal="true"
        aria-label={tr.title}
        className={`fixed top-0 right-0 h-full w-full sm:max-w-xs md:max-w-sm z-50 bg-[var(--background)] border-l border-[var(--border)] shadow-2xl transform transition-transform duration-300 flex flex-col ${
