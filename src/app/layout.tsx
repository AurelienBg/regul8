...
export const metadata: Metadata = {
  ...
  description: "Understand which regulations, licences, and compliance obligations apply to your crypto/blockchain startup — globally. MiCA, MiFID, CASP, VASP, and more across 24 jurisdictions.",
  keywords: [
  ...
  twitter: {
    ...
    title: "Regul8 — Navigate Crypto Regulation. Anywhere.",
    description: "20 activities × 24 jurisdictions. MiCA, CASP, VASP, and more. With deep XRPL coverage.",
    images: ["/logo.svg"],
  },
  icons: {
    icon: "/favicon.svg",
