        ...
        cards: [
          {
            ...
            icon: '🧙',
            title: 'Évaluer',
            desc: 'Diagnostic éclair sur UNE question, ou profil réglementaire complet (multi-activités × multi-juridictions + IA).',
          ...
          },
          {
            ...
            icon: '📚',
            title: 'Apprendre',
            desc: "Concepts clés, spécificités XRPL, cas d'usage, guides, diagrammes, glossaire — la référence complète.",
            cta: 'Explorer',
            accent: 'blue',
          },
        ],
        ...
        cards: [
          {
            ...
            icon: '🧙',
            title: 'Assess',
            desc: 'Quick diagnostic on ONE question, or full regulatory profile (multi-activity × multi-juri + AI audit).',
          ...
          },
          {
            ...
            icon: '📚',
            title: 'Learn',
            desc: 'Core concepts, XRPL specifics, use cases, guides, diagrams, glossary — the full reference.',
            cta: 'Browse library',
            accent: 'blue',
          },
        ],
