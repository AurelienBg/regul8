        ...
        cards: [
          {
            ...
            icon: '🧙',
            title: 'Évaluer',
            desc: 'Diagnostic éclair ou rapport complet — 2 à 10 min.',
          ...
          },
          {
            ...
            icon: '📊',
            title: 'Comparer',
            desc: 'Empilez activités × juridictions côte à côte.',
          ...
          },
          {
            ...
            icon: '📚',
            title: 'Apprendre',
            desc: "Concepts, hub XRPL, cas d'usage, guides, glossaire.",
            cta: 'Explorer',
            accent: 'blue',
          },
        ],
        ...
        cards: [
          {
            ...
            icon: '🧙',
            title: 'Assess',
            desc: 'Quick check or full report — 2 to 10 min.',
          ...
          },
          {
            ...
            icon: '📊',
            title: 'Compare',
            desc: 'Stack activities × jurisdictions side by side.',
            cta: 'Open comparator',
            accent: 'emerald',
          },
          {
            ...
            icon: '📚',
            title: 'Learn',
            desc: 'Core concepts, XRPL hub, use cases, guides & glossary.',
            cta: 'Browse library',
            accent: 'blue',
          },
        ],
