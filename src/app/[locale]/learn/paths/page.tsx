  ...
  return (
    <div className="max-w-5xl mx-auto px-4 py-12">
      ...
      <header className="text-center mb-12">
        ...
        <h1 className="text-3xl sm:text-4xl font-bold mb-3">Learning Paths</h1>
        <p className="text-lg text-gray-600 dark:text-gray-400 max-w-2xl mx-auto">
          Curated reads on the core regulatory frameworks. Each path is a focused 6-10 min dive.
        </p>
      </header>
      ...
      <div className="mt-12 p-5 rounded-xl bg-gray-50 dark:bg-gray-900/50 border border-[var(--border)] text-center">
        <p className="text-sm text-gray-600 dark:text-gray-400">
          More paths coming soon: Liechtenstein Fast Track, US Crypto 101, Stablecoin Frameworks.
        </p>
      </div>
    </div>
  );
